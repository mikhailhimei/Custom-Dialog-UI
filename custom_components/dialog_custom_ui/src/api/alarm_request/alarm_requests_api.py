...
def async_register_alarm_requests_websockets(hass: HomeAssistant) -> None:
    websocket_api.async_register_command(hass, _ws_get_alarm_requests)
...
@websocket_api.websocket_command(GET_ALARM_REQUESTS_SCHEMA)
@websocket_api.async_response
async def _ws_get_alarm_requests(hass, connection, msg):
    alarm_requests = await async_load_alarm_requests(hass)

    connection.send_result(msg["id"], {"data": alarm_requests})
