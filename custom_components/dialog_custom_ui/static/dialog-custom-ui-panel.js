...
function _p() {
  if (Mc) return le;
  Mc = 1;
  var l = Symbol.for("react.element"), i = Symbol.for("react.portal"), s = Symbol.for("react.fragment"), c = Symbol.for("react.strict_mode"), f = Symbol.for("react.profiler"), p = Symbol.for("react.provider"), v = Symbol.for("react.context"), g = Symbol.for("react.forward_ref"), w = Symbol.for("react.suspense"), S = Symbol.for("react.memo"), P = Symbol.for("react.lazy"), x = Symbol.iterator;
  function I(m) {
...
function Ep() {
  return Dc || (Dc = 1, (function(l) {
    ...
    var w = [], S = [], P = 1, x = null, I = 3, A = !1, U = !1, F = !1, T = typeof setTimeout == "function" ? setTimeout : null, L = typeof clearTimeout == "function" ? clearTimeout : null, $ = typeof setImmediate < "u" ? setImmediate : null;
    typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
    function j(B) {
      for (var X = s(S); X !== null; ) {
        if (X.callback === null) c(S);
        else if (X.startTime <= B) c(S), X.sortIndex = X.expirationTime, i(w, X);
        else break;
        X = s(S);
      }
    }
    ...
    l.unstable_IdlePriority = 5, l.unstable_ImmediatePriority = 1, l.unstable_LowPriority = 4, l.unstable_NormalPriority = 3, l.unstable_Profiling = null, l.unstable_UserBlockingPriority = 2, l.unstable_cancelCallback = function(B) {
      ...
      return N = V + N, B = { id: P++, callback: X, priorityLevel: B, startTime: V, expirationTime: N, sortIndex: -1 }, V > m ? (B.sortIndex = V, i(S, B), s(w) === null && B === s(S) && (F ? (L(Pe), Pe = -1) : F = !0, he(G, V - m))) : (B.sortIndex = N, i(w, B), U || A || (U = !0, Ae(te))), B;
...
function kp() {
  ...
  var g = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u"), w = Object.prototype.hasOwnProperty, S = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, P = {}, x = {};
  function I(e) {
    return w.call(x, e) ? !0 : w.call(P, e) ? !1 : S.test(e) ? x[e] = !0 : (P[e] = !0, !1);
  }
  function A(e, t, n, r) {
...
` + a[u].replace(" at new ", " at ");
  ...
  var lf = V({}, pr, { key: function(e) {
    ...
    deltaZ: 0,
    deltaMode: 0
  }), pf = at(ff), mf = [9, 13, 27, 32], qa = g && "CompositionEvent" in window, hr = null;
  g && "documentMode" in document && (hr = document.documentMode);
  var hf = g && "TextEvent" in window && !hr, Ss = g && (!qa || hr && 8 < hr && 11 >= hr), Cs = " ", xs = !1;
  function Ns(e, t) {
    switch (e) {
      case "keyup":
  ...
  var Tf = g && "documentMode" in document && 11 >= document.documentMode, Dn = null, Ja = null, _r = null, ba = !1;
  function $s(e, t, n) {
  ...
  g && (js = document.createElement("div").style, "AnimationEvent" in window || (delete In.animationend.animation, delete In.animationiteration.animation, delete In.animationstart.animation), "TransitionEvent" in window || delete In.transitionend.transition);
  function ml(e) {
    if (Za[e]) return Za[e];
    if (!In[e]) return e;
    var t = In[e], n;
      ...
      e: {
        ...
        if (M !== void 0) {
          ...
          for (var _ = R, C; _ !== null; ) {
            C = _;
            var O = C.stateNode;
            if (C.tag === 5 && O !== null && (C = O, k !== null && (O = rr(_, k), O != null && q.push(kr(_, O, C)))), ze) break;
            _ = _.return;
          }
      ...
      if ((t & 7) === 0) {
        e: {
          ...
          if ((W || M) && (M = z.window === z ? z : (M = z.ownerDocument) ? M.defaultView || M.parentWindow : window, W ? (K = n.relatedTarget || n.toElement, W = R, K = K ? cn(K) : null, K !== null && (ze = un(K), K !== ze || K.tag !== 5 && K.tag !== 6) && (K = null)) : (W = null, K = R), W !== K)) {
            if (q = Es, O = "onMouseLeave", k = "onMouseEnter", _ = "mouse", (e === "pointerout" || e === "pointerover") && (q = ks, O = "onPointerLeave", k = "onPointerEnter", _ = "pointer"), ze = W == null ? M : An(W), C = K == null ? M : An(K), M = new q(O, _ + "leave", W, n, z), M.target = ze, M.relatedTarget = C, O = null, cn(z) === R && (q = new q(k, _ + "enter", K, n, z), q.target = C, q.relatedTarget = ze, O = q), ze = O, W && K) t: {
              for (q = W, k = K, _ = 0, C = q; C; C = On(C)) _++;
              for (C = 0, O = k; O; O = On(O)) C++;
              for (; 0 < _ - C; ) q = On(q), _--;
              for (; 0 < C - _; ) k = On(k), C--;
              for (; _--; ) {
...
`).replace(zf, "");
  ...
  function uu(e) {
    ...
    function o(k, _, C) {
      return k.index = C, e ? (C = k.alternate, C !== null ? (C = C.index, C < _ ? (k.flags |= 2, _) : C) : (k.flags |= 2, _)) : (k.flags |= 1048576, _);
    }
    function u(k) {
      return e && k.alternate === null && (k.flags |= 2), k;
    }
    function h(k, _, C, O) {
      return _ === null || _.tag !== 6 ? (_ = si(C, k.mode, O), _.return = k, _) : (_ = a(_, C), _.return = k, _);
    }
    function y(k, _, C, O) {
      var Y = C.type;
      return Y === ie ? z(k, _, C.props.children, O, C.key) : _ !== null && (_.elementType === Y || typeof Y == "object" && Y !== null && Y.$$typeof === Ae && su(Y) === _.type) ? (O = a(_, C.props), O.ref = xr(k, _, C), O.return = k, O) : (O = Xl(C.type, C.key, C.props, null, k.mode, O), O.ref = xr(k, _, C), O.return = k, O);
    }
    function R(k, _, C, O) {
      return _ === null || _.tag !== 4 || _.stateNode.containerInfo !== C.containerInfo || _.stateNode.implementation !== C.implementation ? (_ = ui(C, k.mode, O), _.return = k, _) : (_ = a(_, C.children || []), _.return = k, _);
    }
    function z(k, _, C, O, Y) {
      return _ === null || _.tag !== 7 ? (_ = wn(C, k.mode, O, Y), _.return = k, _) : (_ = a(_, C), _.return = k, _);
    }
    function D(k, _, C) {
      if (typeof _ == "string" && _ !== "" || typeof _ == "number") return _ = si("" + _, k.mode, C), _.return = k, _;
      if (typeof _ == "object" && _ !== null) {
        switch (_.$$typeof) {
          case te:
            return C = Xl(_.type, _.key, _.props, null, k.mode, C), C.ref = xr(k, null, _), C.return = k, C;
          case re:
            return _ = ui(_, k.mode, C), _.return = k, _;
          case Ae:
            var O = _._init;
            return D(k, O(_._payload), C);
        }
        if (er(_) || X(_)) return _ = wn(_, k.mode, C, null), _.return = k, _;
        Nl(k, _);
      }
      return null;
    }
    function M(k, _, C, O) {
      ...
      if (typeof C == "string" && C !== "" || typeof C == "number") return Y !== null ? null : h(k, _, "" + C, O);
      if (typeof C == "object" && C !== null) {
        switch (C.$$typeof) {
          case te:
            return C.key === Y ? y(k, _, C, O) : null;
          case re:
            return C.key === Y ? R(k, _, C, O) : null;
          case Ae:
            return Y = C._init, M(
              k,
              _,
        ...
        if (er(C) || X(C)) return Y !== null ? null : z(k, _, C, O, null);
        Nl(k, C);
      }
      return null;
    }
    function W(k, _, C, O, Y) {
      if (typeof O == "string" && O !== "" || typeof O == "number") return k = k.get(C) || null, h(_, k, "" + O, Y);
      if (typeof O == "object" && O !== null) {
        switch (O.$$typeof) {
          case te:
            return k = k.get(O.key === null ? C : O.key) || null, y(_, k, O, Y);
          case re:
            return k = k.get(O.key === null ? C : O.key) || null, R(_, k, O, Y);
          case Ae:
            var J = O._init;
            return W(k, _, C, J(O._payload), Y);
        }
        if (er(O) || X(O)) return k = k.get(C) || null, z(_, k, O, Y, null);
        Nl(_, O);
      }
      return null;
    }
    function K(k, _, C, O) {
      for (var Y = null, J = null, b = _, ne = _ = 0, Ue = null; b !== null && ne < C.length; ne++) {
      ...
      if (ne === C.length) return n(k, b), we && pn(k, ne), Y;
      if (b === null) {
        for (; ne < C.length; ne++) b = D(k, C[ne], O), b !== null && (_ = o(b, _, ne), J === null ? Y = b : J.sibling = b, J = b);
        return we && pn(k, ne), Y;
      }
      for (b = r(k, b); ne < C.length; ne++) Ue = W(b, k, ne, C[ne], O), Ue !== null && (e && Ue.alternate !== null && b.delete(Ue.key === null ? ne : Ue.key), _ = o(Ue, _, ne), J === null ? Y = Ue : J.sibling = Ue, J = Ue);
    ...
    function q(k, _, C, O) {
      ...
      for (var J = Y = null, b = _, ne = _ = 0, Ue = null, ce = C.next(); b !== null && !ce.done; ne++, ce = C.next()) {
        b.index > ne ? (Ue = b, b = null) : Ue = b.sibling;
        ...
        e && b && sn.alternate === null && t(k, b), _ = o(sn, _, ne), J === null ? Y = sn : J.sibling = sn, J = sn, b = Ue;
      }
      if (ce.done) return n(
        k,
        b
      ...
      if (b === null) {
        for (; !ce.done; ne++, ce = C.next()) ce = D(k, ce.value, O), ce !== null && (_ = o(ce, _, ne), J === null ? Y = ce : J.sibling = ce, J = ce);
        return we && pn(k, ne), Y;
      }
      for (b = r(k, b); !ce.done; ne++, ce = C.next()) ce = W(b, k, ne, ce.value, O), ce !== null && (e && ce.alternate !== null && b.delete(ce.key === null ? ne : ce.key), _ = o(ce, _, ne), J === null ? Y = ce : J.sibling = ce, J = ce);
      return e && b.forEach(function(gp) {
        return t(k, gp);
      }), we && pn(k, ne), Y;
    }
    function ze(k, _, C, O) {
      if (typeof C == "object" && C !== null && C.type === ie && C.key === null && (C = C.props.children), typeof C == "object" && C !== null) {
        switch (C.$$typeof) {
          case te:
            e: {
              for (var Y = C.key, J = _; J !== null; ) {
                if (J.key === Y) {
                  if (Y = C.type, Y === ie) {
                    if (J.tag === 7) {
                      n(k, J.sibling), _ = a(J, C.props.children), _.return = k, k = _;
                      break e;
                    }
                  } else if (J.elementType === Y || typeof Y == "object" && Y !== null && Y.$$typeof === Ae && su(Y) === J.type) {
                    n(k, J.sibling), _ = a(J, C.props), _.ref = xr(k, J, C), _.return = k, k = _;
                    break e;
                  }
                  n(k, J);
                  break;
              ...
              C.type === ie ? (_ = wn(C.props.children, k.mode, O, C.key), _.return = k, k = _) : (O = Xl(C.type, C.key, C.props, null, k.mode, O), O.ref = xr(k, _, C), O.return = k, k = O);
            }
            return u(k);
          case re:
            e: {
              for (J = C.key; _ !== null; ) {
                if (_.key === J) if (_.tag === 4 && _.stateNode.containerInfo === C.containerInfo && _.stateNode.implementation === C.implementation) {
                  n(k, _.sibling), _ = a(_, C.children || []), _.return = k, k = _;
                  break e;
                } else {
                  n(k, _);
                  break;
              ...
              _ = ui(C, k.mode, O), _.return = k, k = _;
            }
            return u(k);
          case Ae:
            return J = C._init, ze(k, _, J(C._payload), O);
        }
        if (er(C)) return K(k, _, C, O);
        if (X(C)) return q(k, _, C, O);
        Nl(k, C);
      }
      return typeof C == "string" && C !== "" || typeof C == "number" ? (C = "" + C, _ !== null && _.tag === 6 ? (n(k, _.sibling), _ = a(_, C), _.return = k, k = _) : (n(k, _), _ = si(C, k.mode, O), _.return = k, k = _), u(k)) : n(k, _);
    }
    return ze;
  }
          ...
          do {
            switch (o.tag) {
              ...
              case 1:
                ...
                if ((o.flags & 128) === 0 && (typeof _.getDerivedStateFromError == "function" || C !== null && typeof C.componentDidCatch == "function" && (nn === null || !nn.has(C)))) {
                  o.flags |= 65536, t &= -t, o.lanes |= t;
                  var O = Bu(o, h, t);
                  pu(o, O);
                  break e;
      ...
      try {
        if (mt.transition = null, pe = 16 > e ? 16 : e, rn === null) var r = !1;
          ...
          for (Q = _; Q !== null; ) {
            u = Q;
            var C = u.child;
            if ((u.subtreeFlags & 2064) !== 0 && C !== null) C.return = u, Q = C;
            else e: for (u = _; Q !== null; ) {
...
function Tp(l = {}) {
  ...
  function s(f, p) {
    ...
    if (v && v.getAttribute("href")) {
      let w = f.location.href, S = w.indexOf("#");
      g = S === -1 ? w : w.slice(0, S);
    }
...
function Pp(l, i, s, c = {}) {
  let { window: f = document.defaultView, v5Compat: p = !1 } = c, v = f.history, g = "POP", w = null, S = P();
  S == null && (S = 0, v.replaceState({ ...v.state, idx: S }, ""));
  function P() {
    return (v.state || { idx: null }).idx;
  }
  function x() {
    g = "POP";
    let T = P(), L = T == null ? null : T - S;
    S = T, w && w({ action: g, location: F.location, delta: L });
  }
  function I(T, L) {
    g = "PUSH";
    let $ = jc(T) ? T : Ni(F.location, T, L);
    s && s($, T), S = P() + 1;
    let j = Uc($, S), G = F.createHref($.mask || $);
    try {
      v.pushState(j, "", G);
    } catch (te) {
  ...
  function A(T, L) {
    ...
    s && s($, T), S = P();
    let j = Uc($, S), G = F.createHref($.mask || $);
    v.replaceState(j, "", G), p && w && w({ action: g, location: F.location, delta: 0 });
  }
  function U(T) {
    return Lp(f, T);
  }
...
function bc(l, i = [], s = [], c = "", f = !1) {
  let p = (v, g, w = f, S) => {
    let P = {
      relativePath: S === void 0 ? v.path || "" : S,
...
function Hp(l, i, s = !1) {
  ...
  for (let g = 0; g < c.length; ++g) {
    let w = c[g], S = g === c.length - 1, P = p === "/" ? i : i.slice(p.length) || "/", x = da(
      { path: w.relativePath, caseSensitive: w.caseSensitive, end: S },
      P
    ), I = w.route;
    if (!x && S && s && !c[c.length - 1].route.index && (x = da(
      {
        path: w.relativePath,
...
function da(l, i) {
  ...
  return {
    params: c.reduce(
      (S, { paramName: P, isOptional: x }, I) => {
        if (P === "*") {
          let U = g[I] || "";
          v = p.slice(0, p.length - U.length).replace(/(.)\/+$/, "$1");
        }
        const A = g[I];
        return x && !A ? S[P] = void 0 : S[P] = (A || "").replace(/%2F/g, "/"), S;
      },
      {}
    ),
    pathname: p,
...
function ha(l, i, s, c = !1) {
  ...
  let w = Kp(f, g), S = v && v !== "/" && v.endsWith("/"), P = (p || v === ".") && s.endsWith("/");
  return !w.pathname.endsWith("/") && (S || P) && (w.pathname += "/"), w;
}
...
function nd(l, i) {
  ...
  if (td)
    try {
      let p = new URL(window.location.href), v = s.startsWith("//") ? new URL(p.protocol + s) : new URL(s), g = Ht(v.pathname, i);
      v.origin === p.origin && g != null ? s = g + v.search + v.hash : f = !0;
    } catch {
      vt(
        !1,
...
function sm(l, { relative: i } = {}) {
  ...
  let { basename: s, navigator: c } = E.useContext(ut), { hash: f, pathname: p, search: v } = Qr(l, { relative: i }), g = p;
  return s !== "/" && (g = p === "/" ? s : xt([s, p])), c.createHref({ pathname: g, search: v, hash: f });
}
function Zn() {
...
function um() {
  ...
  return sd(() => {
    ...
    (w, S = {}) => {
      ...
      l == null && i !== "/" && (P.pathname = P.pathname === "/" ? i : xt([i, P.pathname])), (S.replace ? s.replace : s.push)(
        P,
        S.state,
        S
      );
...
function ud(l, i, s) {
  ...
  let { navigator: c } = E.useContext(ut), { matches: f } = E.useContext(zt), p = f[f.length - 1], v = p ? p.params : {}, g = p ? p.pathname : "/", w = p ? p.pathnameBase : "/", S = p && p.route;
  {
    let L = S && S.path || "";
    dd(
      g,
...
function hm(l, i = [], s) {
  ...
  if (s && c) {
    ...
    for (let P = 0; P < f.length; P++) {
      ...
      if ((x.route.HydrateFallback || x.route.hydrateFallbackElement) && (g = P), x.route.id) {
        ...
        if (x.route.lazy || U) {
          s.isStatic && (v = !0), g >= 0 ? f = f.slice(0, g + 1) : f = [f[0]];
          break;
        }
      }
    }
  }
  let w = s == null ? void 0 : s.onError, S = c && w ? (P, x) => {
    var I, A;
    w(P, {
      location: c.location,
  ...
  return f.reduceRight(
    (P, x, I) => {
      ...
      c && (A = p && x.route.id ? p[x.route.id] : void 0, F = x.route.errorElement || fm, v && (g < 0 && I === 0 ? (dd(
        "route-fallback",
        !1,
        "No `HydrateFallback` element provided to render during initial hydration"
      ), U = !0, T = null) : g === I && (U = !0, T = x.route.hydrateFallbackElement || null)));
...
function aa({
  ...
  let { matches: p } = E.useContext(zt), { pathname: v } = Dt(), g = Li(), w = ha(
    l,
    Ri(p),
    v,
    c === "path"
  ...
  return E.useEffect(() => {
    g(JSON.parse(S), { replace: i, state: s, relative: c });
  }, [g, S, c, i, s]), null;
}
function rt(l) {
  ke(
...
function Sm({
  ...
  return vt(
    F != null,
    `<Router basename="${g}"> is not able to match the URL "${S}${P}${x}" because it does not start with the basename, so the <Router> won't render anything.`
...
function zm(l, i) {
  ...
  if (Nm(l)) {
    ...
    c = g ? Ht(g, i) : null, s = l.getAttribute("method") || ua, f = Ei(l.getAttribute("enctype")) || ca, p = new FormData(l);
    ...
    if (c = w ? Ht(w, i) : null, s = l.getAttribute("formmethod") || g.getAttribute("method") || ua, f = Ei(l.getAttribute("formenctype")) || Ei(g.getAttribute("enctype")) || ca, p = new FormData(g, l), !Lm()) {
      let { name: S, type: P, value: x } = l;
      if (P === "image") {
        let I = S ? `${S}.` : "";
...
function Vc(l, i, s, c, f, p) {
  let v = (w, S) => s[S] ? w.route.id !== s[S].route.id : !0, g = (w, S) => {
    var P;
    return (
      // param change, /users/123 -> /users/456
      s[S].pathname !== w.pathname || // splat param changed, which is not present in match.path
      // e.g. /files/images/avatar.jpg -> files/finances.xls
      ((P = s[S].route.path) == null ? void 0 : P.endsWith("*")) && s[S].params["*"] !== w.params["*"]
    );
  };
...
function Bm(l, i) {
  let s = E.useContext(Oi), [c, f] = E.useState(!1), [p, v] = E.useState(!1), { onFocus: g, onBlur: w, onMouseEnter: S, onMouseLeave: P, onTouchStart: x } = i, I = E.useRef(null);
  E.useEffect(() => {
...
function Vm({
  ...
  let c = Dt(), { future: f } = Fi(), { basename: p } = Ii(), v = E.useMemo(() => {
    ...
    for (let P of i)
      typeof P.route.shouldRevalidate == "function" ? w = !0 : S.push(P.route.id);
    return w && S.length > 0 && g.searchParams.set("_routes", S.join(",")), [g.pathname + g.search];
  }, [
    p,
    f.v8_trailingSlashAwareDataRequests,
    l,
  ...
  return /* @__PURE__ */ E.createElement(E.Fragment, null, v.map((g) => /* @__PURE__ */ E.createElement("link", { key: g, rel: "prefetch", as: "fetch", href: g, ...s })));
}
function Qm({
  page: l,
  matches: i,
  ...
  let c = Dt(), { future: f, manifest: p, routeModules: v } = Fi(), { basename: g } = Ii(), { loaderData: w, matches: S } = Um(), P = E.useMemo(
    () => Vc(
      l,
      i,
      S,
...
var hd = E.forwardRef(
  function({
    ...
    let x = Qr(v, { relative: S.relative }), I = Dt(), A = E.useContext(va), { navigator: U, basename: F } = E.useContext(ut), T = A != null && // Conditional usage is OK here because the usage of a data router is static
    // eslint-disable-next-line react-hooks/rules-of-hooks
    nh(x) && g === !0, L = U.encodeLocation ? U.encodeLocation(x).pathname : x.pathname, $ = I.pathname, j = A && A.navigation && A.navigation.location ? A.navigation.location.pathname : null;
...
var Gm = E.forwardRef(
  ({
    ...
    let { useTransitions: F } = E.useContext(ut), T = eh(), L = th(g, { relative: S }), $ = v.toLowerCase() === "get" ? "get" : "post", j = typeof g == "string" && pd.test(g), G = (te) => {
...
function Ih({
  ...
  return E.useEffect(() => {
    ...
    /* @__PURE__ */ d.createElement(
      ...
      /* @__PURE__ */ d.createElement("span", null, (g == null ? void 0 : g.label) || s),
...
const Yh = () => {
  const [l, i] = E.useState(), [s, c] = E.useState(), [f, p] = E.useState(!1), [v, g] = E.useState(!1), {
    loading: w,
    scripts: S,
    scriptData: P,
    saveScript: x,
  ...
  return /* @__PURE__ */ d.createElement("div", { className: Cn.page }, /* @__PURE__ */ d.createElement(Kr, null), /* @__PURE__ */ d.createElement("div", { className: Cn.header }, /* @__PURE__ */ d.createElement("div", { className: Cn.heading }, /* @__PURE__ */ d.createElement("h1", { className: Cn.title }, "Создание запускающих скриптов"), /* @__PURE__ */ d.createElement("p", { className: Cn.description }, "Создавайте и редактируйте автоматизации и условия")), /* @__PURE__ */ d.createElement("div", { className: Cn.actions }, /* @__PURE__ */ d.createElement(
    ...
    "Добавить сценарий"
  ))), w && /* @__PURE__ */ d.createElement("div", null, "Загрузка..."), /* @__PURE__ */ d.createElement("div", { className: Cn.list }, S == null ? void 0 : S.map(($) => /* @__PURE__ */ d.createElement(
    Hh,
    {
      key: $.uuid,
      title: $.title,
  ...
  const i = _a(), s = Li(), [c, f] = E.useState(l === "directTemplate" ? "template" : "main"), [p, v] = E.useState(null), [g, w] = E.useState(!1), [S, P] = E.useState(!1), [x, I] = E.useState(!1), [A, U] = E.useState(() => ki(Hr[l])), [F, T] = E.useState(null), L = E.useMemo(() => l === "directMain" || l === "directTemplate" ? c === "main" ? Hr.directMain : Hr.directTemplate : Hr[l], [c, l]), $ = E.useMemo(() => {
    if (L.kind === "dialog")
...
function wd() {
  const l = _a(), [i, s] = E.useState([]), [c, f] = E.useState([]), [p, v] = E.useState([]), [g, w] = E.useState(!0), S = E.useMemo(() => l.getDevices(), [l]), P = E.useCallback(async () => {
...
const Qv = "_page_di7r7_1", Kv = "_header_di7r7_11", qv = "_title_di7r7_18", Yv = "_description_di7r7_25", Gv = "_grid_di7r7_31", Xv = "_card_di7r7_37", Jv = "_empty_di7r7_37", bv = "_cardHeader_di7r7_44", Zv = "_cardTitle_di7r7_51", ey = "_meta_di7r7_56", ty = "_time_di7r7_62", ny = "_form_di7r7_69", ry = "_field_di7r7_75", ly = "_label_di7r7_81", ay = "_select_di7r7_87", oy = "_input_di7r7_87", iy = "_quickTabs_di7r7_97", sy = "_quickTab_di7r7_97", uy = "_activeQuickTab_di7r7_113", cy = "_row_di7r7_118", Z = {
  ...
  const { createTimer: l, devices: i, loading: s, stopTimer: c, timers: f, toTimerSeconds: p } = wd(), [v, g] = E.useState(!1), [w, S] = E.useState(""), [P, x] = E.useState(5), [I, A] = E.useState({});
  E.useEffect(() => {
...
function Py(l) {
  ...
  function f(p, v, g) {
    ...
    let S = !1;
    const P = () => {
      if (w.removeEventListener("close", P), S) {
        g(ma);
        return;
      }
      if (p === 0) {
  ...
  constructor(i, s) {
    this._handleMessage = (c) => {
      ...
      Array.isArray(f) || (f = [f]), f.forEach((p) => {
        ...
        switch (p.type) {
          case "event":
            v ? v.callback(p.event) : (console.warn(`Received event for unknown subscription ${p.id}. Unsubscribing.`), this.sendMessagePromise(qc(p.id)).catch((g) => {
            }));
            break;
          case "result":
          ...
          if (!this.closeRequested)
            try {
              ...
              if (this._queuedMessages) {
                ...
                for (const S of w)
                  S.reject && S.reject(xi);
              }
              g === ma ? this.fireEvent("reconnect-error", g) : p(v + 1);
            }
        }, Math.min(v, 5) * 1e3);
      };
  ...
  async subscribeMessage(i, s, c) {
    ...
    return await new Promise((p, v) => {
      ...
      f = {
        ...
        unsubscribe: async () => {
          this.connected && await this.sendMessagePromise(qc(g)), this.commands.delete(g);
        }
      }, this.commands.set(g, f);
      try {
        this.sendMessage(s, g);
      } catch {
      }
    }), () => f.unsubscribe();
  }
...
async function zy(l, i, s) {
  ...
  i !== null && f.append("client_id", i), Object.keys(s).forEach((g) => {
    f.append(g, s[g]);
  });
...
class Uy extends HTMLElement {
  ...
  connectedCallback() {
    this.shadow || (this.shadow = this.attachShadow({ mode: "open" }), this.container = document.createElement("div"), this.container.className = "dialog-custom-ui-root", this.shadow.appendChild(this.container)), this.loadStyles(), this.render();
  }
  ...
  loadStyles() {
    if (!this.shadow)
      return;
    const i = "dialog-custom-ui-panel.css", s = "dialog-custom-ui-panel.js", c = Array.from(document.getElementsByTagName("script")).find((S) => S.src && S.src.includes(s)), f = c && c.src ? new URL(c.src, window.location.href).search : "", p = `/dialog_custom_ui_static/${i}${f}`, v = new URL(p, window.location.href).href, g = this.shadow.querySelector('link[data-dialog-custom-ui-styles="true"]');
    if (g) {
      g.href !== v && (g.href = p);
      return;
    }
    const w = document.createElement("link");
    w.rel = "stylesheet", w.href = p, w.dataset.dialogCustomUiStyles = "true", this.shadow.prepend(w);
  }
  render() {
    this.isConnected && this.container && (this.root || (this.root = Np.createRoot(this.container)), this.root.render(
