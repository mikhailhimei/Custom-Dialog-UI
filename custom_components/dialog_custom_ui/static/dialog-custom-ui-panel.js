                ...
                <section class="response-item-card ${a?"open":""}">
                  ...
                  ${a?`
                    <div class="response-item-grid">
                      <label>
                        ...
                        <div class="dropdown-container">
                          ...
                          ${e._searchActiveType==="directControl"&&e._searchActiveItemId===i.id&&e._searchResults.length>0?`
                            <div class="dropdown-options">
                              ${e._searchResults.map(l=>`
                                <div class="dropdown-option" data-action="select-search-result" data-direct-control-item-id="${h(i.id)}" data-result-uuid="${h(l.uuid)}" data-result-title="${h(l.title)}" data-result-active-type="${h(l.activeType??"")}">
                                  ${h(l.title)} (${h(l.uuid)})
                                </div>
                              `).join("")}
                            </div>
                      ...
                      ${String(i.activeType??"").trim()?`
                        <label>
                          <span>activeType</span>
                          <input value="${h(i.activeType)}" disabled />
                        </label>
                      `:""}
                      <div class="response-item-actions">
                        <button
