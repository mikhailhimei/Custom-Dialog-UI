...
function sp() {
  ...
  var z = k.prototype = new M();
  z.constructor = k, D(z, E.prototype), z.isPureReactComponent = !0;
  var W = Array.isArray, b = Object.prototype.hasOwnProperty, B = { current: null }, ee = { key: !0, ref: !0, __self: !0, __source: !0 };
  function le(T, A, ue) {
    var de, me = {}, pe = null, we = null;
    if (A != null) for (de in A.ref !== void 0 && (we = A.ref), A.key !== void 0 && (pe = "" + A.key), A) b.call(A, de) && !ee.hasOwnProperty(de) && (me[de] = A[de]);
    var _e = arguments.length - 2;
    if (_e === 1) me.children = ue;
    else if (1 < _e) {
      for (var xe = Array(_e), it = 0; it < _e; it++) xe[it] = arguments[it + 2];
      me.children = xe;
    }
    if (T && T.defaultProps) for (de in _e = T.defaultProps, _e) me[de] === void 0 && (me[de] = _e[de]);
    return { $$typeof: l, type: T, key: pe, ref: we, props: me, _owner: B.current };
  }
  function ve(T, A) {
  ...
  var oe = /\/+/g;
  function Pe(T, A) {
    return typeof T == "object" && T !== null && T.key != null ? Y("" + T.key) : A.toString(36);
  }
  function Ae(T, A, ue, de, me) {
    var pe = typeof T;
    ...
    if (we) return we = T, me = me(we), T = de === "" ? "." + Pe(we, 0) : de, W(me) ? (ue = "", T != null && (ue = T.replace(oe, "$&/") + "/"), Ae(me, A, ue, "", function(it) {
      return it;
    })) : me != null && (ye(me) && (me = ve(me, ue + (!me.key || we && we.key === me.key ? "" : ("" + me.key).replace(oe, "$&/") + "/") + T)), A.push(me)), 1;
    if (we = 0, de = de === "" ? "." : de + ":", W(T)) for (var _e = 0; _e < T.length; _e++) {
      pe = T[_e];
      var xe = de + Pe(pe, _e);
      we += Ae(pe, A, ue, xe, me);
    }
    else if (xe = x(T), typeof xe == "function") for (T = xe.call(T), _e = 0; !(pe = T.next()).done; ) pe = pe.value, xe = de + Pe(pe, _e++), we += Ae(pe, A, ue, xe, me);
    else if (pe === "object") throw A = String(T), Error("Objects are not valid as a React child (found: " + (A === "[object Object]" ? "object with keys {" + Object.keys(T).join(", ") + "}" : A) + "). If you meant to render a collection of children, use an array instead.");
    return we;
  }
  function X(T, A, ue) {
    if (T == null) return T;
    var de = [], me = 0;
    return Ae(T, de, "", "", function(pe) {
  ...
  var $e = { current: null }, H = { transition: null }, ae = { ReactCurrentDispatcher: $e, ReactCurrentBatchConfig: H, ReactCurrentOwner: B };
  function Q() {
    throw Error("act(...) is not supported in production builds of React.");
  }
  return ce.Children = { map: X, forEach: function(T, A, ue) {
    X(T, function() {
    ...
    return T;
  } }, ce.Component = E, ce.Fragment = s, ce.Profiler = f, ce.PureComponent = k, ce.StrictMode = c, ce.Suspense = _, ce.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = ae, ce.act = Q, ce.cloneElement = function(T, A, ue) {
    if (T == null) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + T + ".");
    var de = D({}, T.props), me = T.key, pe = T.ref, we = T._owner;
    if (A != null) {
      if (A.ref !== void 0 && (pe = A.ref, we = B.current), A.key !== void 0 && (me = "" + A.key), T.type && T.type.defaultProps) var _e = T.type.defaultProps;
      for (xe in A) b.call(A, xe) && !ee.hasOwnProperty(xe) && (de[xe] = A[xe] === void 0 && _e !== void 0 ? _e[xe] : A[xe]);
    }
    var xe = arguments.length - 2;
    if (xe === 1) de.children = ue;
    else if (1 < xe) {
      _e = Array(xe);
      for (var it = 0; it < xe; it++) _e[it] = arguments[it + 2];
      de.children = _e;
    }
    return { $$typeof: l, type: T.type, key: me, ref: pe, props: de, _owner: we };
  ...
  }, ce.createElement = le, ce.createFactory = function(T) {
    var A = le.bind(null, T);
    return A.type = T, A;
    ...
    return { $$typeof: N, _payload: { _status: -1, _result: T }, _init: Ie };
  ...
  }, ce.unstable_act = Q, ce.useCallback = function(T, A) {
    return $e.current.useCallback(T, A);
    ...
    return $e.current.useEffect(T, A);
  }, ce.useId = function() {
    return $e.current.useId();
  }, ce.useImperativeHandle = function(T, A, ue) {
    return $e.current.useImperativeHandle(T, A, ue);
  }, ce.useInsertionEffect = function(T, A) {
    return $e.current.useInsertionEffect(T, A);
  }, ce.useLayoutEffect = function(T, A) {
    return $e.current.useLayoutEffect(T, A);
  }, ce.useMemo = function(T, A) {
    return $e.current.useMemo(T, A);
  }, ce.useReducer = function(T, A, ue) {
    return $e.current.useReducer(T, A, ue);
    ...
    return $e.current.useSyncExternalStore(T, A, ue);
...
var od;
function Od() {
  return od || (od = 1, Ai.exports = sp()), Ai.exports;
}
var v = Od();
...
function up() {
  return id || (id = 1, (function(l) {
    ...
    function c(H) {
      ...
      if (Q !== ae) {
        H[0] = Q;
        e: for (var T = 0, A = H.length, ue = A >>> 1; T < ue; ) {
          var de = 2 * (T + 1) - 1, me = H[de], pe = de + 1, we = H[pe];
          if (0 > f(me, Q)) pe < A && 0 > f(we, me) ? (H[T] = we, H[pe] = Q, T = pe) : (H[T] = me, H[de] = Q, T = de);
          else if (pe < A && 0 > f(we, Q)) H[T] = we, H[pe] = Q, T = pe;
          else break e;
        }
      }
      return ae;
    ...
    function f(H, ae) {
      var Q = H.sortIndex - ae.sortIndex;
      return Q !== 0 ? Q : H.id - ae.id;
    }
    ...
    var _ = [], C = [], N = 1, y = null, x = 3, I = !1, D = !1, $ = !1, E = typeof setTimeout == "function" ? setTimeout : null, M = typeof clearTimeout == "function" ? clearTimeout : null, k = typeof setImmediate < "u" ? setImmediate : null;
    typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
    function z(H) {
      for (var ae = s(C); ae !== null; ) {
        if (ae.callback === null) c(C);
        else if (ae.startTime <= H) c(C), ae.sortIndex = ae.expirationTime, o(_, ae);
        else break;
        ae = s(C);
      }
    }
    function W(H) {
      if ($ = !1, z(H), !D) if (s(_) !== null) D = !0, Ie(b);
      else {
        var ae = s(C);
        ae !== null && $e(W, ae.startTime - H);
      }
    }
    function b(H, ae) {
      D = !1, $ && ($ = !1, M(le), le = -1), I = !0;
      var Q = x;
      try {
        for (z(ae), y = s(_); y !== null && (!(y.expirationTime > ae) || H && !Y()); ) {
          var T = y.callback;
          if (typeof T == "function") {
            y.callback = null, x = y.priorityLevel;
            var A = T(y.expirationTime <= ae);
            ae = l.unstable_now(), typeof A == "function" ? y.callback = A : y === s(_) && c(_), z(ae);
          } else c(_);
          y = s(_);
        }
        if (y !== null) var ue = !0;
          ...
          var de = s(C);
          de !== null && $e(W, de.startTime - ae), ue = !1;
        }
        return ue;
      } finally {
        y = null, x = Q, I = !1;
    ...
    var B = !1, ee = null, le = -1, ve = 5, ye = -1;
    function Y() {
      return !(l.unstable_now() - ye < ve);
    }
    function oe() {
      if (ee !== null) {
    ...
    if (typeof k == "function") Pe = function() {
      ...
      Ae.port1.onmessage = oe, Pe = function() {
        X.postMessage(null);
      };
    } else Pe = function() {
      E(oe, 0);
    ...
    l.unstable_IdlePriority = 5, l.unstable_ImmediatePriority = 1, l.unstable_LowPriority = 4, l.unstable_NormalPriority = 3, l.unstable_Profiling = null, l.unstable_UserBlockingPriority = 2, l.unstable_cancelCallback = function(H) {
      ...
      0 > H || 125 < H ? console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported") : ve = 0 < H ? Math.floor(1e3 / H) : 5;
    ...
    }, l.unstable_runWithPriority = function(H, ae) {
      switch (H) {
        case 1:
        case 2:
        case 3:
    ...
    }, l.unstable_scheduleCallback = function(H, ae, Q) {
      var T = l.unstable_now();
      switch (typeof Q == "object" && Q !== null ? (Q = Q.delay, Q = typeof Q == "number" && 0 < Q ? T + Q : T) : Q = T, H) {
        case 1:
          var A = -1;
          break;
        case 2:
      ...
      return A = Q + A, H = { id: N++, callback: ae, priorityLevel: H, startTime: Q, expirationTime: A, sortIndex: -1 }, Q > T ? (H.sortIndex = Q, o(C, H), s(_) === null && H === s(C) && ($ ? (M(le), le = -1) : $ = !0, $e(W, Q - T))) : (H.sortIndex = A, o(_, H), D || I || (D = !0, Ie(b))), H;
    }, l.unstable_shouldYield = Y, l.unstable_wrapCallback = function(H) {
      var ae = x;
      return function() {
        var Q = x;
        x = ae;
...
var sd;
function cp() {
  return sd || (sd = 1, ji.exports = up()), ji.exports;
}
/**
 * @license React
...
function dp() {
  ...
  var W = l.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED, b = Symbol.for("react.element"), B = Symbol.for("react.portal"), ee = Symbol.for("react.fragment"), le = Symbol.for("react.strict_mode"), ve = Symbol.for("react.profiler"), ye = Symbol.for("react.provider"), Y = Symbol.for("react.context"), oe = Symbol.for("react.forward_ref"), Pe = Symbol.for("react.suspense"), Ae = Symbol.for("react.suspense_list"), X = Symbol.for("react.memo"), Ie = Symbol.for("react.lazy"), $e = Symbol.for("react.offscreen"), H = Symbol.iterator;
  function ae(e) {
...
` + a[d].replace(" at new ", " at ");
  ...
  function Va(e, t) {
    ...
    t.hasOwnProperty("value") ? ba(e, t.type, n) : t.hasOwnProperty("defaultValue") && ba(e, t.type, _e(t.defaultValue)), t.checked == null && t.defaultChecked != null && (e.defaultChecked = !!t.defaultChecked);
  }
  function ps(e, t, n) {
  ...
  var mf = Q({ menuitem: !0 }, { area: !0, base: !0, br: !0, col: !0, embed: !0, hr: !0, img: !0, input: !0, keygen: !0, link: !0, meta: !0, param: !0, source: !0, track: !0, wbr: !0 });
  function Ya(e, t) {
    if (t) {
  ...
  var Sr = !1, _l = null, El = !1, to = null, hf = { onError: function(e) {
    Sr = !0, _l = e;
  } };
  function vf(e, t, n, r, a, i, d, g, w) {
    Sr = !1, _l = null, pf.apply(hf, arguments);
  }
  function yf(e, t, n, r, a, i, d, g, w) {
    if (vf.apply(this, arguments), Sr) {
      if (Sr) {
        var L = _l;
        Sr = !1, _l = null;
  ...
  function Ms(e) {
    return e = gf(e), e !== null ? Ls(e) : null;
  }
  function Ls(e) {
  ...
  var Is = o.unstable_scheduleCallback, $s = o.unstable_cancelCallback, _f = o.unstable_shouldYield, Ef = o.unstable_requestPaint, ze = o.unstable_now, wf = o.unstable_getCurrentPriorityLevel, no = o.unstable_ImmediatePriority, Ds = o.unstable_UserBlockingPriority, wl = o.unstable_NormalPriority, kf = o.unstable_LowPriority, zs = o.unstable_IdlePriority, kl = null, It = null;
  function Sf(e) {
  ...
  var St = Math.clz32 ? Math.clz32 : xf, Cf = Math.log, Nf = Math.LN2;
  function xf(e) {
  ...
  function Rf(e, t) {
    for (var n = e.suspendedLanes, r = e.pingedLanes, a = e.expirationTimes, i = e.pendingLanes; 0 < i; ) {
      ...
      w === -1 ? ((g & n) === 0 || (g & r) !== 0) && (a[d] = Tf(g, t)) : w <= t && (e.expiredLanes |= g), i &= ~g;
    }
  }
  function ro(e) {
  ...
  var Fs, oo, js, Us, Bs, io = !1, xl = [], Jt = null, Zt = null, en = null, xr = /* @__PURE__ */ new Map(), Tr = /* @__PURE__ */ new Map(), tn = [], Mf = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
  function Ws(e, t) {
    switch (e) {
      case "focusin":
      case "focusout":
  ...
  function Pr(e, t) {
    e.blockedOn === t && (e.blockedOn = null, io || (io = !0, o.unstable_scheduleCallback(o.unstable_NormalPriority, If)));
  }
  function Mr(e) {
    function t(a) {
      return Pr(a, e);
  ...
  var Wn = W.ReactCurrentBatchConfig, Rl = !0;
  function $f(e, t, n, r) {
    var a = Ee, i = Wn.transition;
    Wn.transition = null;
    try {
      Ee = 1, so(e, t, n, r);
    } finally {
      Ee = a, Wn.transition = i;
    }
  }
  function Df(e, t, n, r) {
    var a = Ee, i = Wn.transition;
  ...
  function so(e, t, n, r) {
    if (Rl) {
      ...
      else if (Ws(e, r), t & 4 && -1 < Mf.indexOf(e)) {
        for (; a !== null; ) {
          var i = Wr(a);
  ...
  }, defaultPrevented: 0, isTrusted: 0 }, fo = st(Hn), Lr = Q({}, Hn, { view: 0, detail: 0 }), zf = st(Lr), mo, po, Ir, $l = Q({}, Lr, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: vo, button: 0, buttons: 0, relatedTarget: function(e) {
  ...
  } }), Ys = st($l), Of = Q({}, $l, { dataTransfer: 0 }), Af = st(Of), Ff = Q({}, Lr, { relatedTarget: 0 }), ho = st(Ff), jf = Q({}, Hn, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), Uf = st(jf), Bf = Q({}, Hn, { clipboardData: function(e) {
    return "clipboardData" in e ? e.clipboardData : window.clipboardData;
  } }), Wf = st(Bf), Hf = Q({}, Hn, { data: 0 }), Ks = st(Hf), Vf = {
    Esc: "Escape",
    Spacebar: " ",
    Left: "ArrowLeft",
    Up: "ArrowUp",
  ...
  var Yf = Q({}, Lr, { key: function(e) {
    if (e.key) {
      var t = Vf[e.key] || e.key;
      if (t !== "Unidentified") return t;
    }
    return e.type === "keypress" ? (e = Ll(e), e === 13 ? "Enter" : String.fromCharCode(e)) : e.type === "keydown" || e.type === "keyup" ? bf[e.keyCode] || "Unidentified" : "";
  ...
  } }), Kf = st(Yf), Gf = Q({}, $l, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), Gs = st(Gf), Xf = Q({}, Lr, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: vo }), Jf = st(Xf), Zf = Q({}, Hn, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), em = st(Zf), tm = Q({}, $l, {
    deltaX: function(e) {
    ...
    deltaZ: 0,
    deltaMode: 0
  }), nm = st(tm), rm = [9, 13, 27, 32], yo = h && "CompositionEvent" in window, $r = null;
  h && "documentMode" in document && ($r = document.documentMode);
  var lm = h && "TextEvent" in window && !$r, Xs = h && (!yo || $r && 8 < $r && 11 >= $r), Js = " ", Zs = !1;
  function eu(e, t) {
    switch (e) {
      case "keyup":
  ...
  var vm = h && "documentMode" in document && 11 >= document.documentMode, bn = null, wo = null, Ar = null, ko = !1;
  function fu(e, t, n) {
  ...
  for (var Co = 0; Co < _u.length; Co++) {
    var No = _u[Co], ym = No.toLowerCase(), gm = No[0].toUpperCase() + No.slice(1);
    rn(ym, "on" + gm);
  }
  ...
  var Fr = "abort canplay canplaythrough durationchange emptied encrypted ended error loadeddata loadedmetadata loadstart pause play playing progress ratechange resize seeked seeking stalled suspend timeupdate volumechange waiting".split(" "), _m = new Set("cancel close invalid load scroll toggle".split(" ").concat(Fr));
  function Eu(e, t, n) {
  ...
  function jr(e) {
    if (!e[Al]) {
      e[Al] = !0, c.forEach(function(n) {
        n !== "selectionchange" && (_m.has(n) || xo(n, !1, e), xo(n, !0, e));
      });
      ...
      e: {
        ...
        if (O !== void 0) {
          ...
          for (var S = L, P; S !== null; ) {
            P = S;
            var U = P.stateNode;
            if (P.tag === 5 && U !== null && (P = U, R !== null && (U = wr(S, R), U != null && G.push(Ur(S, U, P)))), Oe) break;
            S = S.return;
          }
          0 < G.length && (O = new V(O, K, null, n, F), j.push({ event: O, listeners: G }));
        }
      }
      if ((t & 7) === 0) {
        e: {
          if (O = e === "mouseover" || e === "pointerover", V = e === "mouseout" || e === "pointerout", O && n !== Ga && (K = n.relatedTarget || n.fromElement) && (wn(K) || K[Ut])) break e;
          if ((V || O) && (O = F.window === F ? F : (O = F.ownerDocument) ? O.defaultView || O.parentWindow : window, V ? (K = n.relatedTarget || n.toElement, V = L, K = K ? wn(K) : null, K !== null && (Oe = En(K), K !== Oe || K.tag !== 5 && K.tag !== 6) && (K = null)) : (V = null, K = L), V !== K)) {
            if (G = Ys, U = "onMouseLeave", R = "onMouseEnter", S = "mouse", (e === "pointerout" || e === "pointerover") && (G = Gs, U = "onPointerLeave", R = "onPointerEnter", S = "pointer"), Oe = V == null ? O : Kn(V), P = K == null ? O : Kn(K), O = new G(U, S + "leave", V, n, F), O.target = Oe, O.relatedTarget = P, U = null, wn(F) === L && (G = new G(R, S + "enter", K, n, F), G.target = P, G.relatedTarget = Oe, U = G), Oe = U, V && K) t: {
              for (G = V, R = K, S = 0, P = G; P; P = Qn(P)) S++;
            ...
            V !== null && Su(j, O, V, G, !1), K !== null && Oe !== null && Su(j, Oe, K, G, !0);
          }
        }
        e: {
          if (O = L ? Kn(L) : window, V = O.nodeName && O.nodeName.toLowerCase(), V === "select" || V === "input" && O.type === "file") var J = um;
          else if (nu(O)) if (lu) J = mm;
          else {
            J = dm;
            var ne = cm;
          }
          else (V = O.nodeName) && V.toLowerCase() === "input" && (O.type === "checkbox" || O.type === "radio") && (J = fm);
          if (J && (J = J(e, L))) {
            ru(j, J, n, F);
            break e;
          }
          ne && ne(e, O, L), e === "focusout" && (ne = O._wrapperState) && ne.controlled && O.type === "number" && ba(O, "number", O.value);
        }
        switch (ne = L ? Kn(L) : window, e) {
          case "focusin":
            (nu(ne) || ne.contentEditable === "true") && (bn = ne, wo = L, Ar = null);
            break;
          case "focusout":
            Ar = wo = bn = null;
            break;
        ...
        ie && (Xs && n.locale !== "ko" && (Vn || ie !== "onCompositionStart" ? ie === "onCompositionEnd" && Vn && (re = qs()) : (nn = F, co = "value" in nn ? nn.value : nn.textContent, Vn = !0)), ne = Fl(L, ie), 0 < ne.length && (ie = new Ks(ie, e, null, n, F), j.push({ event: ie, listeners: ne }), re ? ie.data = re : (re = tu(n), re !== null && (ie.data = re)))), (re = lm ? am(e, n) : om(e, n)) && (L = Fl(L, "onBeforeInput"), 0 < L.length && (F = new Ks("onBeforeInput", "beforeinput", null, n, F), j.push({ event: F, listeners: L }), F.data = re));
      }
      wu(j, t);
    });
  }
...
`).replace(wm, "");
  ...
  var Lo = typeof setTimeout == "function" ? setTimeout : void 0, km = typeof clearTimeout == "function" ? clearTimeout : void 0, Nu = typeof Promise == "function" ? Promise : void 0, Sm = typeof queueMicrotask == "function" ? queueMicrotask : typeof Nu < "u" ? function(e) {
  ...
  var Yn = Math.random().toString(36).slice(2), $t = "__reactFiber$" + Yn, Br = "__reactProps$" + Yn, Ut = "__reactContainer$" + Yn, $o = "__reactEvents$" + Yn, Nm = "__reactListeners$" + Yn, xm = "__reactHandles$" + Yn;
  function wn(e) {
    var t = e[$t];
    if (t) return t;
  ...
  function Pu(e, t, n) {
    ...
    n ? (e = Ru(e, t, kn), r.__reactInternalMemoizedMergedChildContext = e, Ne(Ze), Ne(Qe), ke(Qe, e)) : Ne(Ze), ke(Ze, n);
  }
  ...
  var ut = null, ct = null, Te = !1, Nt = null;
  function Iu(e, t) {
    ...
    if (Te) {
      ...
      if (t) {
        ...
        if (!$u(e, t)) {
          ...
          t = ln(n.nextSibling);
          var r = ut;
          t && $u(e, t) ? Iu(r, n) : (e.flags = e.flags & -4097 | 2, Te = !1, ut = e);
        }
      } else {
        if (Fo(e)) throw Error(s(418));
        e.flags = e.flags & -4097 | 2, Te = !1, ut = e;
      }
    }
  }
  function Du(e) {
  ...
  var Rm = W.ReactCurrentBatchConfig;
  function Hr(e, t, n) {
  ...
  function Au(e) {
    function t(R, S) {
      if (e) {
        var P = R.deletions;
        P === null ? (R.deletions = [S], R.flags |= 16) : P.push(S);
      }
    }
    function n(R, S) {
      if (!e) return null;
    ...
    function r(R, S) {
      for (R = /* @__PURE__ */ new Map(); S !== null; ) S.key !== null ? R.set(S.key, S) : R.set(S.index, S), S = S.sibling;
      return R;
    }
    function a(R, S) {
      return R = vn(R, S), R.index = 0, R.sibling = null, R;
    }
    function i(R, S, P) {
      return R.index = P, e ? (P = R.alternate, P !== null ? (P = P.index, P < S ? (R.flags |= 2, S) : P) : (R.flags |= 2, S)) : (R.flags |= 1048576, S);
    }
    function d(R) {
      return e && R.alternate === null && (R.flags |= 2), R;
    }
    function g(R, S, P, U) {
      return S === null || S.tag !== 6 ? (S = Li(P, R.mode, U), S.return = R, S) : (S = a(S, P), S.return = R, S);
    }
    function w(R, S, P, U) {
      var J = P.type;
      return J === ee ? F(R, S, P.props.children, U, P.key) : S !== null && (S.elementType === J || typeof J == "object" && J !== null && J.$$typeof === Ie && Ou(J) === S.type) ? (U = a(S, P.props), U.ref = Hr(R, S, P), U.return = R, U) : (U = ga(P.type, P.key, P.props, null, R.mode, U), U.ref = Hr(R, S, P), U.return = R, U);
    }
    function L(R, S, P, U) {
      return S === null || S.tag !== 4 || S.stateNode.containerInfo !== P.containerInfo || S.stateNode.implementation !== P.implementation ? (S = Ii(P, R.mode, U), S.return = R, S) : (S = a(S, P.children || []), S.return = R, S);
    }
    function F(R, S, P, U, J) {
      return S === null || S.tag !== 7 ? (S = In(P, R.mode, U, J), S.return = R, S) : (S = a(S, P), S.return = R, S);
    }
    function j(R, S, P) {
      if (typeof S == "string" && S !== "" || typeof S == "number") return S = Li("" + S, R.mode, P), S.return = R, S;
      if (typeof S == "object" && S !== null) {
        switch (S.$$typeof) {
          case b:
            return P = ga(S.type, S.key, S.props, null, R.mode, P), P.ref = Hr(R, null, S), P.return = R, P;
          case B:
            return S = Ii(S, R.mode, P), S.return = R, S;
          case Ie:
            var U = S._init;
            return j(R, U(S._payload), P);
        }
        if (gr(S) || ae(S)) return S = In(S, R.mode, P, null), S.return = R, S;
        Yl(R, S);
      }
      return null;
    }
    function O(R, S, P, U) {
      ...
      if (typeof P == "string" && P !== "" || typeof P == "number") return J !== null ? null : g(R, S, "" + P, U);
      if (typeof P == "object" && P !== null) {
        switch (P.$$typeof) {
          case b:
            return P.key === J ? w(R, S, P, U) : null;
          case B:
            return P.key === J ? L(R, S, P, U) : null;
          case Ie:
            return J = P._init, O(
              R,
              S,
        ...
        if (gr(P) || ae(P)) return J !== null ? null : F(R, S, P, U, null);
        Yl(R, P);
      }
      return null;
    }
    function V(R, S, P, U, J) {
      if (typeof U == "string" && U !== "" || typeof U == "number") return R = R.get(P) || null, g(S, R, "" + U, J);
      if (typeof U == "object" && U !== null) {
        switch (U.$$typeof) {
          case b:
            return R = R.get(U.key === null ? P : U.key) || null, w(S, R, U, J);
          case B:
            return R = R.get(U.key === null ? P : U.key) || null, L(S, R, U, J);
          case Ie:
            var ne = U._init;
            return V(R, S, P, ne(U._payload), J);
        }
        if (gr(U) || ae(U)) return R = R.get(P) || null, F(S, R, U, J, null);
        Yl(S, U);
      }
      return null;
    }
    function K(R, S, P, U) {
      for (var J = null, ne = null, re = S, ie = S = 0, He = null; re !== null && ie < P.length; ie++) {
        re.index > ie ? (He = re, re = null) : He = re.sibling;
        var he = O(R, re, P[ie], U);
        if (he === null) {
          re === null && (re = He);
          break;
        }
        e && re && he.alternate === null && t(R, re), S = i(he, S, ie), ne === null ? J = he : ne.sibling = he, ne = he, re = He;
      }
      if (ie === P.length) return n(R, re), Te && Cn(R, ie), J;
      if (re === null) {
        for (; ie < P.length; ie++) re = j(R, P[ie], U), re !== null && (S = i(re, S, ie), ne === null ? J = re : ne.sibling = re, ne = re);
        return Te && Cn(R, ie), J;
      }
      for (re = r(R, re); ie < P.length; ie++) He = V(re, R, ie, P[ie], U), He !== null && (e && He.alternate !== null && re.delete(He.key === null ? ie : He.key), S = i(He, S, ie), ne === null ? J = He : ne.sibling = He, ne = He);
    ...
    function G(R, S, P, U) {
      ...
      for (var ne = J = null, re = S, ie = S = 0, He = null, he = P.next(); re !== null && !he.done; ie++, he = P.next()) {
        re.index > ie ? (He = re, re = null) : He = re.sibling;
        var yn = O(R, re, he.value, U);
        if (yn === null) {
          re === null && (re = He);
          break;
        }
        e && re && yn.alternate === null && t(R, re), S = i(yn, S, ie), ne === null ? J = yn : ne.sibling = yn, ne = yn, re = He;
      }
      if (he.done) return n(
        R,
        re
      ...
      if (re === null) {
        for (; !he.done; ie++, he = P.next()) he = j(R, he.value, U), he !== null && (S = i(he, S, ie), ne === null ? J = he : ne.sibling = he, ne = he);
        return Te && Cn(R, ie), J;
      }
      for (re = r(R, re); !he.done; ie++, he = P.next()) he = V(re, R, ie, he.value, U), he !== null && (e && he.alternate !== null && re.delete(he.key === null ? ie : he.key), S = i(he, S, ie), ne === null ? J = he : ne.sibling = he, ne = he);
      return e && re.forEach(function(ip) {
        return t(R, ip);
      }), Te && Cn(R, ie), J;
    }
    function Oe(R, S, P, U) {
      if (typeof P == "object" && P !== null && P.type === ee && P.key === null && (P = P.props.children), typeof P == "object" && P !== null) {
        switch (P.$$typeof) {
          case b:
            e: {
              for (var J = P.key, ne = S; ne !== null; ) {
                if (ne.key === J) {
                  if (J = P.type, J === ee) {
                    if (ne.tag === 7) {
                      n(R, ne.sibling), S = a(ne, P.props.children), S.return = R, R = S;
                      break e;
                    }
                  } else if (ne.elementType === J || typeof J == "object" && J !== null && J.$$typeof === Ie && Ou(J) === ne.type) {
                    n(R, ne.sibling), S = a(ne, P.props), S.ref = Hr(R, ne, P), S.return = R, R = S;
                    break e;
                  }
                  n(R, ne);
                  break;
              ...
              P.type === ee ? (S = In(P.props.children, R.mode, U, P.key), S.return = R, R = S) : (U = ga(P.type, P.key, P.props, null, R.mode, U), U.ref = Hr(R, S, P), U.return = R, R = U);
            }
            return d(R);
          case B:
            e: {
              for (ne = P.key; S !== null; ) {
                if (S.key === ne) if (S.tag === 4 && S.stateNode.containerInfo === P.containerInfo && S.stateNode.implementation === P.implementation) {
                  n(R, S.sibling), S = a(S, P.children || []), S.return = R, R = S;
                  break e;
                } else {
                  n(R, S);
                  break;
              ...
              S = Ii(P, R.mode, U), S.return = R, R = S;
            }
            return d(R);
          case Ie:
            return ne = P._init, Oe(R, S, ne(P._payload), U);
        }
        if (gr(P)) return K(R, S, P, U);
        if (ae(P)) return G(R, S, P, U);
        Yl(R, P);
      }
      return typeof P == "string" && P !== "" || typeof P == "number" ? (P = "" + P, S !== null && S.tag === 6 ? (n(R, S.sibling), S = a(S, P), S.return = R, R = S) : (n(R, S), S = Li(P, R.mode, U), S.return = R, R = S), d(R)) : n(R, S);
    }
    return Oe;
  }
  ...
  function Jl(e, t, n, r) {
    ...
    if (i !== null) {
      ...
      do {
        ...
        if ((r & O) === O) {
          ...
          e: {
            ...
            switch (O = t, V = n, G.tag) {
              ...
              case 0:
                if (K = G.payload, O = typeof K == "function" ? K.call(V, j, O) : K, O == null) break e;
                j = Q({}, j, O);
                break e;
              case 2:
                un = !0;
        ...
        } else V = { eventTime: V, lane: O, tag: g.tag, payload: g.payload, callback: g.callback, next: null }, F === null ? (L = F = V, w = j) : F = F.next = V, d |= O;
        if (g = g.next, g === null) {
  ...
  function Qo(e, t) {
    switch (ke(qr, t), ke(br, e), ke(Dt, Vr), e = t.nodeType, e) {
      case 9:
      case 11:
  ...
  var ea = W.ReactCurrentDispatcher, Xo = W.ReactCurrentBatchConfig, Tn = 0, Le = null, je = null, Be = null, ta = !1, Qr = !1, Yr = 0, Pm = 0;
  function Ye() {
    throw Error(s(321));
  }
  function Jo(e, t) {
  ...
  function Zo(e, t, n, r, a, i) {
    if (Tn = i, Le = t, t.memoizedState = null, t.updateQueue = null, t.lanes = 0, ea.current = e === null || e.memoizedState === null ? $m : Dm, e = n(r, a), Qr) {
      i = 0;
      do {
        if (Qr = !1, Yr = 0, 25 <= i) throw Error(s(301));
        i += 1, Be = je = null, t.updateQueue = null, ea.current = zm, e = n(r, a);
      } while (Qr);
    }
  ...
  function Xu(e) {
    var t = zt();
    return typeof e == "function" && (e = e()), t.memoizedState = t.baseState = e, e = { pending: null, interleaved: null, lanes: 0, dispatch: null, lastRenderedReducer: Kr, lastRenderedState: e }, t.queue = e, e = e.dispatch = Im.bind(null, Le, e), [t.memoizedState, e];
  }
  function Gr(e, t, n, r) {
  ...
  var la = { readContext: vt, useCallback: Ye, useContext: Ye, useEffect: Ye, useImperativeHandle: Ye, useInsertionEffect: Ye, useLayoutEffect: Ye, useMemo: Ye, useReducer: Ye, useRef: Ye, useState: Ye, useDebugValue: Ye, useDeferredValue: Ye, useTransition: Ye, useMutableSource: Ye, useSyncExternalStore: Ye, useId: Ye, unstable_isNewReconciler: !1 }, $m = { readContext: vt, useCallback: function(e, t) {
    ...
    var r = zt();
    return t = n !== void 0 ? n(t) : t, r.memoizedState = r.baseState = t, e = { pending: null, interleaved: null, lanes: 0, dispatch: null, lastRenderedReducer: e, lastRenderedState: t }, r.queue = e, e = e.dispatch = Lm.bind(null, Le, e), [r.memoizedState, e];
  }, useRef: function(e) {
    var t = zt();
    ...
    var e = Xu(!1), t = e[0];
    return e = Mm.bind(null, e[1]), zt().memoizedState = e, [t, e];
  ...
  }, zm = { readContext: vt, useCallback: lc, useContext: vt, useEffect: ri, useImperativeHandle: rc, useInsertionEffect: ec, useLayoutEffect: tc, useMemo: ac, useReducer: ni, useRef: Ju, useState: function() {
    return ni(Kr);
...
` + i.stack;
  ...
  var Am = W.ReactCurrentOwner, tt = !1;
  function Xe(e, t, n, r) {
  ...
  function _c(e, t, n, r, a) {
    n = n.render;
    var i = t.ref;
    return rr(t, a), r = Zo(e, t, n, r, i, a), n = ei(), e !== null && !tt ? (t.updateQueue = e.updateQueue, t.flags &= -2053, e.lanes &= ~a, qt(e, t, a)) : (Te && n && Oo(t), t.flags |= 1, Xe(e, t, r, a), t.child);
  }
  ...
  function kc(e, t, n) {
    ...
    if (r.mode === "hidden") if ((t.mode & 1) === 0) t.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }, ke(ir, dt), dt |= n;
    else {
      if ((n & 1073741824) === 0) return e = i !== null ? i.baseLanes | n : n, t.lanes = t.childLanes = 1073741824, t.memoizedState = { baseLanes: e, cachePool: null, transitions: null }, t.updateQueue = null, ke(ir, dt), dt |= e, null;
      t.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }, r = i !== null ? i.baseLanes : n, ke(ir, dt), dt |= r;
    }
    else i !== null ? (r = i.baseLanes | n, t.memoizedState = null) : r = n, ke(ir, dt), dt |= r;
  ...
  function ui(e, t, n, r, a) {
    ...
    return i = Xn(t, i), rr(t, a), n = Zo(e, t, n, r, i, a), r = ei(), e !== null && !tt ? (t.updateQueue = e.updateQueue, t.flags &= -2053, e.lanes &= ~a, qt(e, t, a)) : (Te && r && Oo(t), t.flags |= 1, Xe(e, t, n, a), t.child);
  }
  function Cc(e, t, n, r, a) {
    ...
    if (rr(t, a), t.stateNode === null) ia(e, t), fc(t, n, r), oi(t, n, r, a), r = !0;
      ...
      (F = typeof V == "function" || typeof d.getSnapshotBeforeUpdate == "function") || typeof d.UNSAFE_componentWillReceiveProps != "function" && typeof d.componentWillReceiveProps != "function" || (g !== j || O !== w) && mc(t, d, r, w), un = !1, O = t.memoizedState, d.state = O, Jl(t, r, d, a);
      var K = t.memoizedState;
      g !== j || O !== K || Ze.current || un ? (typeof V == "function" && (ai(t, n, V, r), K = t.memoizedState), (L = un || dc(t, n, L, r, O, K, w) || !1) ? (F || typeof d.UNSAFE_componentWillUpdate != "function" && typeof d.componentWillUpdate != "function" || (typeof d.componentWillUpdate == "function" && d.componentWillUpdate(r, K, w), typeof d.UNSAFE_componentWillUpdate == "function" && d.UNSAFE_componentWillUpdate(r, K, w)), typeof d.componentDidUpdate == "function" && (t.flags |= 4), typeof d.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof d.componentDidUpdate != "function" || g === e.memoizedProps && O === e.memoizedState || (t.flags |= 4), typeof d.getSnapshotBeforeUpdate != "function" || g === e.memoizedProps && O === e.memoizedState || (t.flags |= 1024), t.memoizedProps = r, t.memoizedState = K), d.props = r, d.state = K, d.context = w, r = L) : (typeof d.componentDidUpdate != "function" || g === e.memoizedProps && O === e.memoizedState || (t.flags |= 4), typeof d.getSnapshotBeforeUpdate != "function" || g === e.memoizedProps && O === e.memoizedState || (t.flags |= 1024), r = !1);
    }
  ...
  function Tc(e, t, n) {
    ...
    if ((g = d) || (g = e !== null && e.memoizedState === null ? !1 : (a & 2) !== 0), g ? (i = !0, t.flags &= -129) : (e === null || e.memoizedState !== null) && (a |= 1), ke(Me, a & 1), e === null)
    ...
    if (a = e.memoizedState, a !== null && (g = a.dehydrated, g !== null)) return Fm(e, t, d, r, g, a, n);
    if (i) {
  ...
  function Fm(e, t, n, r, a, i, d) {
    ...
    return a.data === "$?" ? (t.flags |= 128, t.child = e.child, t = Xm.bind(null, e), a._reactRetry = t, null) : (e = i.treeContext, ct = ln(a.nextSibling), ut = t, Te = !0, Nt = null, e !== null && (pt[ht++] = Wt, pt[ht++] = Ht, pt[ht++] = Sn, Wt = e.id, Ht = e.overflow, Sn = t), t = mi(t, r.children), t.flags |= 4096, t);
  }
  function Rc(e, t, n) {
    e.lanes |= t;
    var r = e.alternate;
    ...
    switch (t.tag) {
      ...
      case 13:
        if (r = t.memoizedState, r !== null)
          return r.dehydrated !== null ? (ke(Me, Me.current & 1), t.flags |= 128, null) : (n & t.child.childLanes) !== 0 ? Tc(e, t, n) : (ke(Me, Me.current & 1), e = qt(e, t, n), e !== null ? e.sibling : null);
        ke(Me, Me.current & 1);
        break;
      case 19:
  ...
  Mc = function(e, t) {
    ...
    if (a !== r) {
      ...
      for (L in r) {
        ...
        else L === "dangerouslySetInnerHTML" ? (w = w ? w.__html : void 0, g = g ? g.__html : void 0, w != null && g !== w && (i = i || []).push(L, w)) : L === "children" ? typeof w != "string" && typeof w != "number" || (i = i || []).push(L, "" + w) : L !== "suppressContentEditableWarning" && L !== "suppressHydrationWarning" && (f.hasOwnProperty(L) ? (w != null && L === "onScroll" && Ce("scroll", e), i || g === w || (i = [])) : (i = i || []).push(L, w));
      }
      n && (i = i || []).push("style", n);
      var L = i;
  ...
  function Um(e, t, n) {
    ...
    switch (Ao(t), t.tag) {
      ...
      case 3:
        return r = t.stateNode, lr(), Ne(Ze), Ne(Qe), Go(), r.pendingContext && (r.context = r.pendingContext, r.pendingContext = null), (e === null || e.child === null) && (Ql(t) ? t.flags |= 4 : e === null || e.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024, Nt !== null && (xi(Nt), Nt = null))), hi(e, t), Ke(t), null;
      case 5:
        Yo(t);
        var a = xn(qr.current);
        if (n = t.type, e !== null && t.stateNode != null) Lc(e, t, n, r, a), e.ref !== t.ref && (t.flags |= 512, t.flags |= 2097152);
          ...
          if (e = xn(Dt.current), Ql(t)) {
            ...
            switch (r[$t] = t, r[Br] = i, e = (t.mode & 1) !== 0, n) {
              ...
              case "video":
              case "audio":
                for (a = 0; a < Fr.length; a++) Ce(Fr[a], r);
                break;
              case "source":
                Ce("error", r);
                break;
            ...
            for (var d in i) if (i.hasOwnProperty(d)) {
              ...
              d === "children" ? typeof g == "string" ? r.textContent !== g && (i.suppressHydrationWarning !== !0 && jl(r.textContent, g, e), a = ["children", g]) : typeof g == "number" && r.textContent !== "" + g && (i.suppressHydrationWarning !== !0 && jl(
                ...
                g,
                e
              ), a = ["children", "" + g]) : f.hasOwnProperty(d) && g != null && d === "onScroll" && Ce("scroll", r);
            }
            switch (n) {
              case "input":
                vl(r), ps(r, i, !0);
            ...
            e: {
              switch (d = Ka(n, r), n) {
                ...
                case "video":
                case "audio":
                  for (a = 0; a < Fr.length; a++) Ce(Fr[a], e);
                  a = r;
                  break;
                case "source":
                  Ce("error", e), a = r;
                ...
                case "details":
                  ...
                  break;
                case "input":
                  fs(e, r), a = Ha(e, r), Ce("invalid", e);
                  break;
                case "option":
                  a = r;
                  break;
                case "select":
                  e._wrapperState = { wasMultiple: !!r.multiple }, a = Q({}, r, { value: void 0 }), Ce("invalid", e);
                  break;
                case "textarea":
                  hs(e, r), a = qa(e, r), Ce("invalid", e);
                  break;
                default:
                  a = r;
              }
              ...
              for (i in g) if (g.hasOwnProperty(i)) {
                var w = g[i];
                i === "style" ? ws(e, w) : i === "dangerouslySetInnerHTML" ? (w = w ? w.__html : void 0, w != null && _s(e, w)) : i === "children" ? typeof w == "string" ? (n !== "textarea" || w !== "") && _r(e, w) : typeof w == "number" && _r(e, "" + w) : i !== "suppressContentEditableWarning" && i !== "suppressHydrationWarning" && i !== "autoFocus" && (f.hasOwnProperty(i) ? w != null && i === "onScroll" && Ce("scroll", e) : w != null && z(e, i, w, d));
              }
              switch (n) {
                case "input":
                  vl(e), ps(e, r, !1);
      ...
      case 13:
        if (Ne(Me), r = t.memoizedState, e === null || e.memoizedState !== null && e.memoizedState.dehydrated !== null) {
          if (Te && ct !== null && (t.mode & 1) !== 0 && (t.flags & 128) === 0) zu(), er(), t.flags |= 98560, i = !1;
      ...
      case 19:
        ...
        if (r = (t.flags & 128) !== 0, d = i.rendering, d === null) if (r) Xr(i, !1);
          ...
          i.tail !== null && ze() > sr && (t.flags |= 128, r = !0, Xr(i, !1), t.lanes = 4194304);
        }
        else {
          if (!r) if (e = Zl(d), e !== null) {
            if (t.flags |= 128, r = !0, n = e.updateQueue, n !== null && (t.updateQueue = n, t.flags |= 4), Xr(i, !0), i.tail === null && i.tailMode === "hidden" && !d.alternate && !Te) return Ke(t), null;
          } else 2 * ze() - i.renderingStartTime > sr && n !== 1073741824 && (t.flags |= 128, r = !0, Xr(i, !1), t.lanes = 4194304);
  ...
  function Bm(e, t) {
    switch (Ao(t), t.tag) {
      ...
      case 3:
        return lr(), Ne(Ze), Ne(Qe), Go(), e = t.flags, (e & 65536) !== 0 && (e & 128) === 0 ? (t.flags = e & -65537 | 128, t) : null;
      case 5:
        return Yo(t), null;
      case 13:
    ...
    if (Ro = Rl, e = du(), Eo(e)) {
      if ("selectionStart" in e) var n = { start: e.selectionStart, end: e.selectionEnd };
        ...
        if (r && r.rangeCount !== 0) {
          ...
          t: for (; ; ) {
            for (var V; j !== n || a !== 0 && j.nodeType !== 3 || (g = d + a), j !== i || r !== 0 && j.nodeType !== 3 || (w = d + r), j.nodeType === 3 && (d += j.nodeValue.length), (V = j.firstChild) !== null; )
              O = j, j = V;
            for (; ; ) {
              if (j === e) break t;
              if (O === n && ++L === a && (g = d), O === i && ++F === r && (w = d), (V = j.nextSibling) !== null) break;
              j = O, O = j.parentNode;
            }
            j = V;
          }
    ...
    for (Po = { focusedElem: e, selectionRange: n }, Rl = !1, q = t; q !== null; ) if (t = q, e = t.child, (t.subtreeFlags & 1028) !== 0 && e !== null) e.return = t, q = e;
      ...
      try {
        ...
        if ((t.flags & 1024) !== 0) switch (t.tag) {
          ...
          case 1:
            if (K !== null) {
              var G = K.memoizedProps, Oe = K.memoizedState, R = t.stateNode, S = R.getSnapshotBeforeUpdate(t.elementType === t.type ? G : xt(t.type, G), Oe);
              R.__reactInternalSnapshotBeforeUpdate = S;
            }
            break;
          case 3:
  ...
  function Dc(e) {
    var t = e.alternate;
    t !== null && (e.alternate = null, Dc(t)), e.child = null, e.deletions = null, e.sibling = null, e.tag === 5 && (t = e.stateNode, t !== null && (delete t[$t], delete t[Br], delete t[$o], delete t[Nm], delete t[xm])), e.stateNode = null, e.return = null, e.dependencies = null, e.memoizedProps = null, e.memoizedState = null, e.pendingProps = null, e.stateNode = null, e.updateQueue = null;
  }
  function zc(e) {
  ...
  function jc(e, t) {
    ...
    switch (e.tag) {
          ...
          if (e.updateQueue = null, w !== null) try {
            ...
            switch (g) {
              ...
              case "select":
                ...
                var V = i.value;
                V != null ? jn(a, !!i.multiple, V, !1) : O !== !!i.multiple && (i.defaultValue != null ? jn(
                  a,
                  !!i.multiple,
                  i.defaultValue,
                  !0
      ...
      case 4:
        ...
        break;
      case 13:
        Rt(t, e), Ot(e), a = e.child, a.flags & 8192 && (i = a.memoizedState !== null, a.stateNode.isHidden = i, !i || a.alternate !== null && a.alternate.memoizedState !== null || (ki = ze())), r & 4 && Fc(e);
        break;
      case 22:
  ...
  var bm = Math.ceil, ca = W.ReactCurrentDispatcher, Ei = W.ReactCurrentOwner, gt = W.ReactCurrentBatchConfig, fe = 0, We = null, Fe = null, qe = 0, dt = 0, ir = an(0), Ue = 0, Zr = null, Rn = 0, da = 0, wi = 0, el = null, nt = null, ki = 0, sr = 1 / 0, Qt = null, fa = !1, Si = null, fn = null, ma = !1, mn = null, pa = 0, tl = 0, Ci = null, ha = -1, va = 0;
  function Je() {
    return (fe & 6) !== 0 ? ze() : ha !== -1 ? ha : ha = ze();
  }
  function pn(e) {
    return (e.mode & 1) === 0 ? 1 : (fe & 2) !== 0 && qe !== 0 ? qe & -qe : Rm.transition !== null ? (va === 0 && (va = Os()), va) : (e = Ee, e !== 0 || (e = window.event, e = e === void 0 ? 16 : bs(e.type)), e);
  }
  function Pt(e, t, n, r) {
    if (50 < tl) throw tl = 0, Ci = null, Error(s(185));
    Nr(e, n, r), ((fe & 2) === 0 || e !== We) && (e === We && ((fe & 2) === 0 && (da |= n), Ue === 4 && hn(e, qe)), rt(e, r), n === 1 && fe === 0 && (t.mode & 1) === 0 && (sr = ze() + 500, Vl && sn()));
  }
  function rt(e, t) {
    ...
    if (r === 0) n !== null && $s(n), e.callbackNode = null, e.callbackPriority = 0;
      ...
      if (n != null && $s(n), t === 1) e.tag === 0 ? Tm(bc.bind(null, e)) : Mu(bc.bind(null, e)), Sm(function() {
        (fe & 6) === 0 && sn();
      }), n = null;
      else {
        switch (As(r)) {
  ...
  function Vc(e, t) {
    ...
    if ((r & 30) !== 0 || (r & e.expiredLanes) !== 0 || t) t = ya(e, r);
      ...
      fe |= 2;
      var i = Qc();
      (We !== e || qe !== t) && (Qt = null, sr = ze() + 500, Mn(e, t));
      do
        try {
          Ym();
          break;
      ...
      while (!0);
      Wo(), ca.current = i, fe = a, Fe !== null ? t = 0 : (We = null, qe = 0, t = Ue);
    }
    if (t !== 0) {
      if (t === 2 && (a = ro(e), a !== 0 && (r = a, t = Ni(e, a))), t === 1) throw n = Zr, Mn(e, 0), hn(e, r), rt(e, ze()), n;
      if (t === 6) hn(e, r);
      else {
        if (a = e.current.alternate, (r & 30) === 0 && !qm(a) && (t = ya(e, r), t === 2 && (i = ro(e), i !== 0 && (r = i, t = Ni(e, i))), t === 1)) throw n = Zr, Mn(e, 0), hn(e, r), rt(e, ze()), n;
        switch (e.finishedWork = a, e.finishedLanes = r, t) {
          ...
          case 2:
            ...
            break;
          case 3:
            if (hn(e, r), (r & 130023424) === r && (t = ki + 500 - ze(), 10 < t)) {
              if (Nl(e, 0) !== 0) break;
    ...
    return rt(e, ze()), e.callbackNode === n ? Vc.bind(null, e) : null;
  }
  function Ni(e, t) {
    var n = el;
  ...
  function bc(e) {
    ...
    if (n === 1) throw n = Zr, Mn(e, 0), hn(e, t), rt(e, ze()), n;
  ...
  function Ti(e, t) {
    ...
    try {
      ...
      fe = n, fe === 0 && (sr = ze() + 500, Vl && sn());
    }
  }
  function Pn(e) {
    mn !== null && mn.tag === 0 && (fe & 6) === 0 && ur();
    var t = fe;
    fe |= 1;
    ...
    try {
      ...
      Ee = r, gt.transition = n, fe = t, (fe & 6) === 0 && sn();
    }
  }
  function Ri() {
    dt = ir.current, Ne(ir);
  ...
  function Mn(e, t) {
    ...
    if (n !== -1 && (e.timeoutHandle = -1, km(n)), Fe !== null) for (n = Fe.return; n !== null; ) {
      var r = n;
      switch (Ao(r), r.tag) {
        case 1:
      ...
      try {
        ...
        e: {
          ...
          if (t = qe, g.flags |= 32768, w !== null && typeof w == "object" && typeof w.then == "function") {
            ...
            var V = yc(d);
            if (V !== null) {
              V.flags &= -257, gc(V, d, g, i, t), V.mode & 1 && vc(i, L, t), t = V, w = L;
              var K = t.updateQueue;
              if (K === null) {
            ...
            var Oe = yc(d);
            if (Oe !== null) {
              (Oe.flags & 65536) === 0 && (Oe.flags |= 256), gc(Oe, d, g, i, t), Uo(ar(w, g));
              break e;
            }
          }
          ...
          do {
            switch (i.tag) {
              ...
              case 1:
                ...
                if ((i.flags & 128) === 0 && (typeof S.getDerivedStateFromError == "function" || P !== null && typeof P.componentDidCatch == "function" && (fn === null || !fn.has(P)))) {
                  i.flags |= 65536, t &= -t, i.lanes |= t;
                  var U = hc(i, g, t);
                  Bu(i, U);
                  break e;
  ...
  function ya(e, t) {
    ...
    while (!0);
    if (Wo(), fe = n, ca.current = r, Fe !== null) throw Error(s(261));
  ...
  function Ln(e, t, n) {
    var r = Ee, a = gt.transition;
    try {
      gt.transition = null, Ee = 1, Km(e, t, n, r);
    } finally {
      gt.transition = a, Ee = r;
    }
    return null;
  }
  function Km(e, t, n, r) {
    ...
    if (Pf(e, i), e === We && (Fe = We = null, qe = 0), (n.subtreeFlags & 2064) === 0 && (n.flags & 2064) === 0 || ma || (ma = !0, Zc(wl, function() {
      return ur(), null;
      ...
      Ee = 1;
      var g = fe;
      fe |= 4, Ei.current = null, Hm(e, n), jc(n, e), hm(Po), Rl = !!Ro, Po = Ro = null, e.current = n, Vm(n), Ef(), fe = g, Ee = d, gt.transition = i;
    } else e.current = n;
  ...
  function ur() {
    if (mn !== null) {
      var e = As(pa), t = gt.transition, n = Ee;
      try {
        if (gt.transition = null, Ee = 16 > e ? 16 : e, mn === null) var r = !1;
        else {
          ...
          if (fe = a, sn(), It && typeof It.onPostCommitFiberRoot == "function") try {
  ...
  function Gm(e, t, n) {
    var r = e.pingCache;
    r !== null && r.delete(t), t = Je(), e.pingedLanes |= e.suspendedLanes & n, We === e && (qe & n) === n && (Ue === 4 || Ue === 3 && (qe & 130023424) === qe && 500 > ze() - ki ? Mn(e, 0) : wi |= n), rt(e, t);
  }
  function Xc(e, t) {
  ...
  Jc = function(e, t, n) {
    if (e !== null) if (e.memoizedProps !== t.pendingProps || Ze.current) tt = !0;
      ...
      if ((e.lanes & n) === 0 && (t.flags & 128) === 0) return tt = !1, jm(e, t, n);
      tt = (e.flags & 131072) !== 0;
    }
    else tt = !1, Te && (t.flags & 1048576) !== 0 && Lu(t, ql, t.index);
      ...
      case 3:
        e: {
          ...
          if (r = d.element, i.isDehydrated) if (i = { element: r, isDehydrated: !1, cache: d.cache, pendingSuspenseBoundaries: d.pendingSuspenseBoundaries, transitions: d.transitions }, t.updateQueue.baseState = i, t.memoizedState = i, t.flags & 256) {
            ...
            break e;
          } else for (ct = ln(t.stateNode.containerInfo.firstChild), ut = t, Te = !0, Nt = null, n = Fu(t, null, r, n), t.child = n; n; ) n.flags = n.flags & -3 | 4096, n = n.sibling;
          else {
            if (er(), r === a) {
              t = qt(e, t, n);
              break e;
  ...
  function ga(e, t, n, r, a, i) {
    ...
    if (r = e, typeof e == "function") Mi(e) && (d = 1);
      ...
      case le:
        ...
        break;
      case ve:
        return e = _t(12, n, t, a | 2), e.elementType = ve, e.lanes = i, e;
      case Pe:
        return e = _t(13, n, t, a), e.elementType = Pe, e.lanes = i, e;
      case Ae:
        return e = _t(19, n, t, a), e.elementType = Ae, e.lanes = i, e;
      case $e:
        return _a(n, a, i, t);
      default:
  ...
  function _a(e, t, n, r) {
    return e = _t(22, e, r, t), e.elementType = $e, e.lanes = n, e.stateNode = { isHidden: !1 }, e;
  }
  function Li(e, t, n) {
  ...
  function $i(e, t, n, r, a, i, d, g, w) {
    return e = new tp(e, t, n, g, w), t === 1 ? (t = 1, i === !0 && (t |= 8)) : t = 0, i = _t(3, null, null, t), e.current = i, i.stateNode = e, i.memoizedState = { element: r, isDehydrated: n, cache: null, transitions: null, pendingSuspenseBoundaries: null }, qo(i), e;
  }
  function np(e, t, n) {
    var r = 3 < arguments.length && arguments[3] !== void 0 ? arguments[3] : null;
    return { $$typeof: B, key: r == null ? null : "" + r, children: e, containerInfo: t, implementation: n };
  }
  function ed(e) {
    if (!e) return on;
    e = e._reactInternals;
    ...
    switch (e.tag) {
      case 3:
        ...
        if (t.current.memoizedState.isDehydrated) {
          ...
          n !== 0 && (ao(t, n | 1), rt(t, ze()), (fe & 6) === 0 && (sr = ze() + 500, sn()));
        }
        break;
      case 13:
        Pn(function() {
...
function fp() {
  ...
  return l(), Fi.exports = dp(), Fi.exports;
}
var dd;
function mp() {
  if (dd) return xa;
...
function gp(l, o, s, c = {}) {
  ...
  function x(E, M) {
    h = "PUSH";
    let k = md(E) ? E : Zi($.location, E, M);
    s && s(k, E), C = N() + 1;
    let z = pd(k, C), W = $.createHref(k.mask || k);
    try {
      p.pushState(z, "", W);
    } catch (b) {
  ...
  function I(E, M) {
    ...
    s && s(k, E), C = N();
    let z = pd(k, C), W = $.createHref(k.mask || k);
    p.replaceState(z, "", W), m && _ && _({ action: h, location: $.location, delta: 0 });
  }
  function D(E) {
    return _p(f, E);
  }
...
function zp(l, o = "/") {
  ...
  return s ? (s = Ud(s), s.startsWith("/") ? m = vd(s.substring(1), "/") : m = vd(s, o)) : m = o, {
    pathname: m,
    search: Fp(c),
    hash: jp(f)
  };
...
var Ud = (l) => l.replace(/\/\/+/g, "/"), Mt = (l) => Ud(l.join("/")), Oa = (l) => l.replace(/\/+$/, ""), Ap = (l) => Oa(l).replace(/^\/*/, "/"), Fp = (l) => !l || l === "?" ? "" : l.startsWith("?") ? l : "?" + l, jp = (l) => !l || l === "#" ? "" : l.startsWith("#") ? l : "#" + l, Up = class {
...
function lh(l, o = [], s) {
  ...
  return f.reduceRight(
    (N, y, x) => {
      ...
      c && (I = m && y.route.id ? m[y.route.id] : void 0, $ = y.route.errorElement || th, p && (h < 0 && x === 0 ? (Xd(
        "route-fallback",
        !1,
        "No `HydrateFallback` element provided to render during initial hydration"
      ), D = !0, E = null) : h === x && (D = !0, E = y.route.hydrateFallbackElement || null)));
      let M = o.concat(f.slice(0, x + 1)), k = () => {
        let z;
...
function ch() {
  ...
  return Yd(() => {
    ...
    async (f, m = {}) => {
      Et(s.current, Qd), s.current && (typeof f == "number" ? await l.navigate(f) : await l.navigate(f, { fromRouteId: o, ...m }));
    },
    [l, o]
  );
}
...
function Dh({
  ...
  let c = wt(), { future: f, manifest: m, routeModules: p } = cs(), { basename: h } = ss(), { loaderData: _, matches: C } = Ph(), N = v.useMemo(
    ...
    if (o.forEach((k) => {
      var W;
      let z = m.routes[k.route.id];
      !z || !z.hasLoader || (!N.some((b) => b.route.id === k.route.id) && k.route.id in _ && ((W = p[k.route.id]) != null && W.shouldRevalidate) || z.hasClientLoader ? E = !0 : $.add(k.route.id));
    }), $.size === 0)
      return [];
    let M = Jd(
      l,
    ...
    return E && $.size > 0 && M.searchParams.set(
      "_routes",
      o.filter((k) => $.has(k.route.id)).map((k) => k.route.id).join(",")
    ), [M.pathname + M.search];
  }, [
    h,
    f.v8_trailingSlashAwareDataRequests,
...
var Zd = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, ef = v.forwardRef(
  function({
    ...
    let { basename: E, navigator: M, useTransitions: k } = v.useContext(mt), z = typeof N == "string" && Zd.test(N), W = Wd(N, E);
    N = W.to;
    let b = Xp(N, { relative: f }), B = wt(), ee = null;
    if (h) {
      let X = Ua(
        h,
        [],
      ...
      E !== "/" && (X.pathname = X.pathname === "/" ? E : Mt([E, X.pathname])), ee = M.createHref(X);
    }
    let [le, ve, ye] = Mh(
      c,
      D
    ...
    let Pe = !(W.isExternal || m), Ae = (
      ...
      /* @__PURE__ */ v.createElement(
        "a",
        {
          ...D,
          ...ye,
          href: (Pe ? ee : void 0) || W.absoluteURL || b,
          onClick: Pe ? oe : o,
          ref: zh($, ve),
          target: C,
    ...
    return le && !z ? /* @__PURE__ */ v.createElement(v.Fragment, null, Ae, /* @__PURE__ */ v.createElement(Lh, { page: b })) : Ae;
  }
);
ef.displayName = "Link";
var Ve = v.forwardRef(
  function({
    ...
    bh(y) && h === !0, M = D.encodeLocation ? D.encodeLocation(y).pathname : y.pathname, k = x.pathname, z = I && I.navigation && I.navigation.location ? I.navigation.location.pathname : null;
    s || (k = k.toLowerCase(), z = z ? z.toLowerCase() : null, M = M.toLowerCase()), z && $ && (z = Yt(z, $) || z);
    const W = M !== "/" && M.endsWith("/") ? M.length - 1 : M.length;
    let b = k === M || !f && k.startsWith(M) && k.charAt(W) === "/", B = z != null && (z === M || !f && z.startsWith(M) && z.charAt(M.length) === "/"), ee = {
      isActive: b,
      isPending: B,
      isTransitioning: E
    }, le = b ? o : void 0, ve;
    typeof c == "function" ? ve = c(ee) : ve = [
      c,
      b ? "active" : null,
      B ? "pending" : null,
...
var Fh = v.forwardRef(
  ({
    ...
    let { useTransitions: $ } = v.useContext(mt), E = Hh(), M = Vh(h, { relative: C }), k = p.toLowerCase() === "get" ? "get" : "post", z = typeof h == "string" && Zd.test(h), W = (b) => {
      if (_ && _(b), b.defaultPrevented) return;
      b.preventDefault();
      let B = b.nativeEvent.submitter, ee = (B == null ? void 0 : B.getAttribute("formmethod")) || p, le = () => E(B || b.currentTarget, {
        fetcherKey: o,
        method: ee,
        navigate: s,
        replace: f,
...
var ts = /* @__PURE__ */ new Map(), Pa = /* @__PURE__ */ new WeakMap(), _d = 0, qh;
function Qh(l) {
...
function Yh(l) {
  return Object.keys(l).sort().filter(
    (o) => l[o] !== void 0
  ).map((o) => `${o}_${o === "root" ? Qh(l.root) : l[o]}`).toString();
}
function Kh(l) {
  const o = Yh(l);
  let s = ts.get(o);
...
function Gh(l, o, s = {}, c = qh) {
  ...
  const { id: f, observer: m, elements: p } = Kh(s), h = p.get(l) || [];
...
function hr({
  ...
  I.current = C, v.useEffect(
    () => {
      ...
      return W = Gh(
        ...
        (b, B) => {
          const ee = D.current;
          D.current = b, !(ee === void 0 && !b) && (E({
            inView: b,
            entry: B
          }), I.current && I.current(b, B), B.isIntersecting && m && W && (W(), W = void 0));
        },
        {
          root: f,
          rootMargin: c,
  ...
  const M = (N = $.entry) == null ? void 0 : N.target, k = v.useRef(void 0);
  !y && M && !m && !p && k.current !== M && (k.current = M, E({
    inView: !!h,
    entry: void 0
  }), D.current = h);
...
const Zh = "_subtitle_g5b3f_1", ev = "_card_g5b3f_6", tv = "_content_g5b3f_50", nv = "_title_g5b3f_58", rv = "_arrow_g5b3f_64", ll = {
  subtitle: Zh,
  card: ev,
  content: tv,
  title: nv,
...
), lv = "_button_2udlt_1", av = "_full_2udlt_32", ov = "_primary_2udlt_37", iv = "_secondary_2udlt_50", sv = "_ghost_2udlt_62", Vi = {
  button: lv,
  full: av,
  primary: ov,
  secondary: iv,
  ...
  l,
  f
), uv = "_pagination_1hg7e_1", cv = "_button_1hg7e_9", dv = "_label_1hg7e_33", Ma = {
  pagination: uv,
  button: cv,
  label: dv
}, vr = ({
  ...
  "Вперёд"
)), fv = "_overlay_49s9e_1", mv = "_modal_49s9e_13", pv = "_sm_49s9e_27", hv = "_md_49s9e_31", vv = "_lg_49s9e_35", yv = "_xl_49s9e_39", gv = "_header_49s9e_43", _v = "_title_49s9e_53", Ev = "_body_49s9e_60", wv = "_footer_49s9e_67", kv = "_close_49s9e_77", gn = {
  overlay: fv,
  modal: mv,
  sm: pv,
  md: hv,
...
) : null), Sv = "_overlay_w83z1_1", Cv = "_sheet_w83z1_11", Nv = "_handle_w83z1_21", $n = {
  overlay: Sv,
  sheet: Cv,
  handle: Nv
}, lf = ({
...
}, xv = "_content_1p38v_1", Tv = "_title_1p38v_7", Rv = "_actions_1p38v_14", bi = {
  content: xv,
  title: Tv,
  actions: Rv
}, Pv = ({
...
}, Mv = "_accordion_1wwmk_1", Lv = "_header_1wwmk_7", Iv = "_content_1wwmk_20", La = {
  accordion: Mv,
  header: Lv,
  content: Iv
}, Ft = ({
...
}, $v = "_field_lqqcp_1", Dv = "_label_lqqcp_8", zv = "_input_lqqcp_16", Ov = "_error_lqqcp_50", Av = "_errorText_lqqcp_63", al = {
  field: $v,
  label: Dv,
  input: zv,
  error: Ov,
...
}, Fv = "_wrapper_1vsqt_1", jv = "_labelRow_1vsqt_6", Uv = "_label_1vsqt_6", Bv = "_selectedTitle_1vsqt_25", Wv = "_dropdown_1vsqt_34", Hv = "_option_1vsqt_49", Vv = "_title_1vsqt_71", bv = "_uuid_1vsqt_76", qv = "_hint_1vsqt_77", At = {
  wrapper: Fv,
  labelRow: jv,
  label: Uv,
  selectedTitle: Bv,
  ...
  const C = ml(), [N, y] = v.useState([]), [x, I] = v.useState(!1), [D, $] = v.useState(!1), [E, M] = v.useState(!1), k = v.useRef(0), z = v.useRef(""), W = v.useMemo(() => o.trim(), [o]);
  v.useEffect(() => {
    if (!W) {
      z.current = "", y([]), I(!1);
      return;
    ...
    const ee = window.setTimeout(async () => {
      ...
      try {
        let le = [];
        for (const ve of c) {
          const ye = await C.searchAssistantCommands(W, ve), Y = Array.isArray(ye == null ? void 0 : ye.data) ? ye.data : [];
          le.push(...Y);
        }
        if (k.current !== B)
          return;
  ...
  const b = (B) => {
    const ee = h ? h(B) : B.uuid;
    m(ee), p == null || p(B), I(!1);
  };
  return /* @__PURE__ */ u.createElement("div", { className: At.wrapper }, /* @__PURE__ */ u.createElement("div", { className: At.labelRow }, /* @__PURE__ */ u.createElement("span", { className: At.label }, l), s && /* @__PURE__ */ u.createElement("span", { className: At.selectedTitle }, s)), /* @__PURE__ */ u.createElement(
    Se,
    {
      value: o,
      autoComplete: "off",
  ...
  ), x && /* @__PURE__ */ u.createElement("div", { className: At.dropdown }, N.map((B) => /* @__PURE__ */ u.createElement(
    "button",
    {
      key: B.uuid,
      type: "button",
    ...
    /* @__PURE__ */ u.createElement("span", { className: At.title }, B.title || "Без названия"),
    /* @__PURE__ */ u.createElement("span", { className: At.uuid }, B.uuid),
    B.mappingType && /* @__PURE__ */ u.createElement("span", { className: At.uuid }, "mappingType: ", B.mappingType)
  ))), D && /* @__PURE__ */ u.createElement("span", { className: At.hint }, "Поиск..."));
}, Qv = "_field_xxbds_1", Yv = "_row_xxbds_5", Kv = "_inputWrapper_xxbds_11", Gv = "_deleteButton_xxbds_15", _n = {
  field: Qv,
  row: Yv,
  inputWrapper: Kv,
  deleteButton: Gv
...
const ey = (l) => {
  for (const o in l)
    if (o.startsWith("aria-") || o === "role" || o === "title")
      return !0;
  return !1;
}, ty = v.createContext({}), ny = () => v.useContext(ty), ry = v.forwardRef(
  ({ color: l, size: o, strokeWidth: s, absoluteStrokeWidth: c, className: f = "", children: m, iconNode: p, ...h }, _) => {
    const {
      ...
      className: I = ""
    } = ny() ?? {}, D = c ?? y ? Number(s ?? N) * 24 / Number(o ?? C) : s ?? N;
    return v.createElement(
      "svg",
      {
        ...
        stroke: l ?? x,
        strokeWidth: D,
        className: af("lucide", I, f),
        ...!m && !ey(h) && { "aria-hidden": "true" },
        ...h
      },
      [
...
const Lt = (l, o) => {
  const s = v.forwardRef(
    ({ className: c, ...f }, m) => v.createElement(ry, {
      ref: m,
      iconNode: o,
      className: af(
        `lucide-${Jv(Ed(l))}`,
 ...
 * See the LICENSE file in the root directory of this source tree.
 */
const sy = [["path", { d: "m6 9 6 6 6-6", key: "qrunsl" }]], uy = Lt("chevron-down", sy);
/**
 * @license lucide-react v1.23.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
], ky = Lt("workflow", wy), Sy = "_dropdown_x51vc_2", Cy = "_label_x51vc_9", Ny = "_wrapper_x51vc_17", xy = "_select_x51vc_21", Ty = "_arrow_x51vc_61", Ry = "_error_x51vc_81", Py = "_errorText_x51vc_99", Dn = {
  dropdown: Sy,
  label: Cy,
  wrapper: Ny,
  select: xy,
...
const Ly = "_form_xh0jo_1", Iy = "_section_xh0jo_7", $y = "_sectionTitle_xh0jo_18", Dy = "_conditions_xh0jo_37", zy = "_addCondition_xh0jo_43", cr = {
  form: Ly,
  section: Iy,
  sectionTitle: $y,
  conditions: Dy,
  ...
  const y = (E) => {
    ...
    return h.name.trim() || (E.name = "Обязательное поле"), h.script_entity_id || (E.script_entity_id = "Обязательное поле"), h.conditions.forEach(
      (M, k) => {
        const z = {};
        M.parent_type.trim() || (z.parent_type = "Обязательное поле"), M.children_type !== void 0 && !M.children_type.trim() && (z.children_type = "Обязательное поле"), M.children_direct_type !== void 0 && !M.children_direct_type.trim() && (z.children_direct_type = "Обязательное поле"), E.conditions[k] = z;
      }
  ...
  return /* @__PURE__ */ u.createElement(
    ...
    /* @__PURE__ */ u.createElement("div", { className: cr.form }, /* @__PURE__ */ u.createElement("div", { className: cr.section }, /* @__PURE__ */ u.createElement(
      ...
      (E, M, k) => /* @__PURE__ */ u.createElement(
        Xv,
        {
          key: M,
          index: M,
...
}, Ay = "_header_1m7ok_1", Fy = "_title_1m7ok_15", jy = "_backButton_1m7ok_22", Uy = "_homeButton_1m7ok_23", Ia = {
  header: Ay,
  title: Fy,
  backButton: jy,
  homeButton: Uy
  ...
  return /* @__PURE__ */ u.createElement("header", { className: Ia.header }, /* @__PURE__ */ u.createElement(
    ...
    /* @__PURE__ */ u.createElement(oy, { size: 18 })
    ...
    /* @__PURE__ */ u.createElement(yy, { size: 18 })
  ));
}, By = "_tabs_17nxl_1", Wy = "_dropdown_17nxl_14", Hy = "_tab_17nxl_1", Vy = "_active_17nxl_43", by = "_menu_17nxl_53", qy = "_menuItem_17nxl_80", ge = {
  tabs: By,
  dropdown: Wy,
  tab: Hy,
  active: Vy,
  ...
  if (!kt())
    return /* @__PURE__ */ u.createElement("div", { className: ge.tabs }, /* @__PURE__ */ u.createElement(
      ...
      /* @__PURE__ */ u.createElement(my, { size: 16, strokeWidth: 2 }),
      ...
      /* @__PURE__ */ u.createElement(Ey, { size: 16, strokeWidth: 2 }),
  ...
  return s ? /* @__PURE__ */ u.createElement("nav", { className: wd.nav }, /* @__PURE__ */ u.createElement(Ve, { to: "/commands/main" }, /* @__PURE__ */ u.createElement(ol, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Основные")), /* @__PURE__ */ u.createElement(Ve, { to: "/commands/sub" }, /* @__PURE__ */ u.createElement(ol, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Второстепенные")), /* @__PURE__ */ u.createElement(Ve, { to: "/commands/direct/main" }, /* @__PURE__ */ u.createElement(ol, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Прямые")), /* @__PURE__ */ u.createElement(Ve, { to: "/commands/settings" }, /* @__PURE__ */ u.createElement(ol, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Настройки"))) : /* @__PURE__ */ u.createElement("nav", { className: wd.nav }, /* @__PURE__ */ u.createElement(Ve, { to: "/scripts" }, /* @__PURE__ */ u.createElement(ky, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Скрипты")), /* @__PURE__ */ u.createElement(
    ...
    /* @__PURE__ */ u.createElement("span", null, "Команды")
  ), /* @__PURE__ */ u.createElement(Ve, { to: "/timer" }, /* @__PURE__ */ u.createElement(dy, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Таймер")), /* @__PURE__ */ u.createElement(Ve, { to: "/alarm" }, /* @__PURE__ */ u.createElement(of, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Будильник")), /* @__PURE__ */ u.createElement(Ve, { to: "/settings" }, /* @__PURE__ */ u.createElement(sf, { size: 20 }), /* @__PURE__ */ u.createElement("span", null, "Настройки")));
}, Yy = "_container_1nl2q_1", Ky = "_visible_1nl2q_20", kd = {
  container: Yy,
  visible: Ky
}, yr = ({
  children: l,
...
}, Gy = "_page_qfpja_7", Xy = "_header_qfpja_15", Jy = "_heading_qfpja_27", Zy = "_title_qfpja_32", eg = "_description_qfpja_41", tg = "_actions_qfpja_48", ng = "_list_qfpja_75", ot = {
  page: Gy,
  header: Xy,
  heading: Jy,
  title: Zy,
  ...
  const l = kt(), { ref: o, inView: s } = hr({
    ...
    updateScript: W,
    getScriptAction: b,
    deleteScriptAction: B
  } = Jh();
  v.useEffect(() => {
    !I || !l || !s || $ || !E || E.page >= E.total_pages || k(E.page + 1, !0);
  }, [
    s,
    l,
    $,
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, $ && /* @__PURE__ */ u.createElement("div", null, "Загрузка..."), /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement("div", { className: ot.page }, /* @__PURE__ */ u.createElement(Gt, null), /* @__PURE__ */ u.createElement("div", { className: ot.header }, /* @__PURE__ */ u.createElement("div", { className: ot.heading }, l ? /* @__PURE__ */ u.createElement(u.Fragment, null) : /* @__PURE__ */ u.createElement("h1", { className: ot.title }, "Сценарии"), /* @__PURE__ */ u.createElement("p", { className: ot.description }, "Создавайте автоматизации для управления устройствами и объединяйте действия в единые сценарии.")), /* @__PURE__ */ u.createElement("div", { className: ot.actions }, l ? /* @__PURE__ */ u.createElement(yr, null, /* @__PURE__ */ u.createElement(
    ...
    "🞢 Добавить сценарий"
  ))), /* @__PURE__ */ u.createElement("div", { className: ot.list }, E == null ? void 0 : E.script_actions.map((oe) => /* @__PURE__ */ u.createElement(
    rf,
    {
      key: oe.uuid,
      title: oe.title,
...
}, lg = "_field_1qtfn_1", ag = "_label_1qtfn_7", og = "_select_1qtfn_13", Qi = {
  field: lg,
  label: ag,
  select: og
}, ns = ({
...
}, ig = "_switchRow_1lfy8_1", sg = "_input_1lfy8_11", ug = "_track_1lfy8_22", cg = "_thumb_1lfy8_33", dg = "_label_1lfy8_62", il = {
  switchRow: ig,
  input: sg,
  track: ug,
  thumb: cg,
  label: dg
}, On = ({ label: l, className: o = "", ...s }) => /* @__PURE__ */ u.createElement("label", { className: `${il.switchRow} ${o}` }, /* @__PURE__ */ u.createElement("input", { ...s, type: "checkbox", className: il.input }), /* @__PURE__ */ u.createElement("span", { className: il.track, "aria-hidden": "true" }, /* @__PURE__ */ u.createElement("span", { className: il.thumb })), /* @__PURE__ */ u.createElement("span", { className: il.label }, l)), fg = "_field_veq7g_1", mg = "_label_veq7g_7", pg = "_textarea_veq7g_13", hg = "_error_veq7g_40", vg = "_errorText_veq7g_48", sl = {
  field: fg,
  label: mg,
  textarea: pg,
  error: hg,
...
), o && /* @__PURE__ */ u.createElement("span", { className: sl.errorText }, o)), yg = [
...
], Eg = "_form_nymr0_1", wg = "_field_nymr0_15", kg = "_arrayItem_nymr0_37", ul = {
  form: Eg,
  field: wg,
  arrayItem: kg
}, Sd = () => ({
  ...
  const _ = v.useMemo(() => {
    ...
    var k;
    const E = {};
    return s.title.trim() || (E.title = "Обязательное поле"), (k = _.actionType) != null && k.trim() || (E.actionType = "Обязательное поле"), N(E), Object.keys(E).length === 0;
  };
  return /* @__PURE__ */ u.createElement(
    Kt,
    {
...
`)
      ...
      Se,
      {
        label: "actionType",
        value: E.actionType,
        onChange: (k) => x("voiceResponseArray", M, {
      ...
      ns,
      {
        ...
        options: _g,
        onChange: (k) => x("nextAction", M, {
          actionTypeComponent: k.target.value
        })
      }
    ), /* @__PURE__ */ u.createElement(
      Se,
      ...
      dr,
      {
        ...
        selectedTitle: E.title,
        searchSource: ["search_assistant_sub_direct_controls"],
        onChange: (k) => x("nextDirectControl", M, {
          uuid: k
        }),
        onSelect: (k) => x("nextDirectControl", M, {
          uuid: k.uuid,
...
}, Sg = "_content_19r5a_1", Cg = "_title_19r5a_7", Ng = "_actions_19r5a_14", Yi = {
  content: Sg,
  title: Cg,
  actions: Ng
}, pl = ({
...
function hl(l) {
  const o = ml(), [s, c] = v.useState(null), [f, m] = v.useState(!0), p = v.useRef(!1), h = async (I, D = 1, $ = !1) => {
    m(!0);
    try {
      const E = xg(await o._getShort(`${I}`, D));
      c((M) => !$ || !M ? E : {
        ...E,
        data: [
          ...M.data,
...
const Tg = () => ({
  ...
  const l = kt(), [o, s] = v.useState(!1), [c, f] = v.useState(!1), [m, p] = v.useState(
    ...
    editStatusCommand: M,
    commands: k
  } = hl("get_assistant_commands_short"), [z, W] = v.useState(!1);
  v.useEffect(() => {
    !z || !l || !N || y || !k || k.page >= k.total_pages || x("get_assistant_commands_short", k.page + 1, !0);
  }, [N, l, y, k, x]), v.useEffect(() => {
    !y && k && k.page === 1 && W(!0);
  }, [y, k]);
  const b = () => {
    f(!1), p(Cd()), s(!0);
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, y && /* @__PURE__ */ u.createElement("div", null, "Загрузка..."), /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement("div", { className: ot.page }, /* @__PURE__ */ u.createElement(Gt, null), /* @__PURE__ */ u.createElement("div", { className: ot.header }, /* @__PURE__ */ u.createElement("div", { className: ot.heading }, l ? /* @__PURE__ */ u.createElement(u.Fragment, null) : /* @__PURE__ */ u.createElement("h1", { className: ot.title }, "Комманды"), /* @__PURE__ */ u.createElement("p", { className: ot.description }, "Создавайте команды для управления устройствами и объединяйте действия в единые сценарии.")), /* @__PURE__ */ u.createElement("div", { className: ot.actions }, l ? /* @__PURE__ */ u.createElement(yr, null, /* @__PURE__ */ u.createElement(se, { variant: "primary", onClick: b }, "Добавить сценарий")) : /* @__PURE__ */ u.createElement(se, { variant: "primary", onClick: b }, "🞢 Добавить сценарий"))), /* @__PURE__ */ u.createElement("div", { className: ot.list }, k == null ? void 0 : k.data.map((Y) => /* @__PURE__ */ u.createElement(
    ...
    vr,
    {
      ...
      onChange: (Y) => x("get_assistant_commands_short", Y)
    }
  ), /* @__PURE__ */ u.createElement(
    uf,
    {
...
}, Pg = "_page_qfpja_7", Mg = "_header_qfpja_15", Lg = "_headerTop_qfpja_20", Ig = "_heading_qfpja_27", $g = "_description_qfpja_41", Dg = "_state_qfpja_83", te = {
  page: Pg,
  header: Mg,
  headerTop: Lg,
  heading: Ig,
  ...
  const l = kt(), [o, s] = v.useState(!1), [c, f] = v.useState(!1), [m, p] = v.useState(() => Nd()), [h, _] = v.useState(null), { ref: C, inView: N } = hr({
    ...
    editStatusCommand: M,
    commands: k
  } = hl("get_assistant_sub_commands_short"), [z, W] = v.useState(!1);
  v.useEffect(() => {
    !z || !l || !N || y || !k || k.page >= k.total_pages || x("get_assistant_sub_commands_short", k.page + 1, !0);
  }, [
    N,
    l,
    y,
  ...
  const b = () => {
    ...
    f(!0);
    const oe = await D("get_assistant_sub_command", Y.uuid);
    p(oe.data), s(!0);
  }, ee = async (Y, oe) => {
    await M("update_assistant_sub_command_status", Y, oe), x("get_assistant_sub_commands_short");
  }, le = async (Y) => {
    await I("delete_assistant_sub_command", Y), x("get_assistant_sub_commands_short");
  }, ve = async () => {
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement("div", { className: te.page }, l ? /* @__PURE__ */ u.createElement(u.Fragment, null) : /* @__PURE__ */ u.createElement(Gt, null), y && /* @__PURE__ */ u.createElement("div", { className: te.state }, "Загрузка..."), /* @__PURE__ */ u.createElement("div", { className: te.header }, /* @__PURE__ */ u.createElement("div", { className: te.headerTop }, /* @__PURE__ */ u.createElement("div", { className: te.heading }, /* @__PURE__ */ u.createElement("p", { className: te.description }, "Создавайте и редактируйте голосовые команды ассистента.")), l ? /* @__PURE__ */ u.createElement(yr, null, /* @__PURE__ */ u.createElement(
    ...
    "Добавить сценарий"
  ))), /* @__PURE__ */ u.createElement("div", { className: te.commandList }, k == null ? void 0 : k.data.map((Y) => /* @__PURE__ */ u.createElement("div", { key: Y.uuid, className: te.commandTab }, /* @__PURE__ */ u.createElement("button", { type: "button", className: te.commandButton, onClick: () => B(Y) }, /* @__PURE__ */ u.createElement("span", null, Y.title), /* @__PURE__ */ u.createElement("small", null, Y.status === !1 ? "Выключена" : "Включена")), /* @__PURE__ */ u.createElement(
    "button",
    {
      type: "button",
      className: te.moreButton,
      "aria-label": `Действия команды ${Y.title}`,
      onClick: () => _(Y)
    },
    "⋯"
  )))), l ? /* @__PURE__ */ u.createElement("div", { ref: C, style: { height: 1 } }) : /* @__PURE__ */ u.createElement(
    vr,
    {
      page: (k == null ? void 0 : k.page) || 1,
      totalPages: (k == null ? void 0 : k.total_pages) || 1,
      onChange: (Y) => x("get_assistant_sub_commands_short", Y)
    }
  ), /* @__PURE__ */ u.createElement(
    uf,
    {
...
`)
  ...
  const l = kt(), [o, s] = v.useState(!1), [c, f] = v.useState(!1), [m, p] = v.useState(() => Td()), [h, _] = v.useState(null), C = [
    ...
    loadCommands: E,
    deleteCommand: M,
    detailInformationCommand: k,
    saveCommand: z,
    updateCommand: W,
    editStatusCommand: b,
    commands: B
  } = hl("get_assistant_sub_direct_controls_short"), [ee, le] = v.useState(!1);
  v.useEffect(() => {
    !ee || !l || !D || $ || !B || B.page >= B.total_pages || E("get_assistant_sub_direct_controls_short", B.page + 1, !0);
  }, [
    D,
    l,
    $,
  ...
  const ve = () => {
    ...
    f(!0);
    const Ie = await k("get_assistant_sub_direct_control", X.uuid);
    p(Ie.data), s(!0);
  }, Y = async (X, Ie) => {
    await b("update_assistant_sub_direct_controls_status", X, Ie), E("get_assistant_sub_direct_controls_short");
  }, oe = async (X) => {
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement("div", { className: te.page }, l ? /* @__PURE__ */ u.createElement(u.Fragment, null) : /* @__PURE__ */ u.createElement(Gt, null), $ && /* @__PURE__ */ u.createElement("div", { className: te.state }, "Загрузка..."), /* @__PURE__ */ u.createElement("div", { className: te.header }, /* @__PURE__ */ u.createElement("div", { className: te.headerTop }, /* @__PURE__ */ u.createElement("div", { className: te.innerTabs }, C.map((X) => /* @__PURE__ */ u.createElement(
    "button",
    {
      key: X.key,
      type: "button",
      className: `${te.innerTab} ${N === X.key ? te.activeInnerTab : ""}`,
      onClick: () => {
        y(X.key), x(`/commands/direct/${X.key === "main" ? "main" : "template"}`);
      }
    },
    X.label
    ...
    "Добавить сценарий"
  ))), /* @__PURE__ */ u.createElement("div", { className: te.commandList }, B == null ? void 0 : B.data.map((X) => /* @__PURE__ */ u.createElement("div", { key: X.uuid, className: te.commandTab }, /* @__PURE__ */ u.createElement("button", { type: "button", className: te.commandButton, onClick: () => ye(X) }, /* @__PURE__ */ u.createElement("span", null, X.title), /* @__PURE__ */ u.createElement("small", null, X.status === !1 ? "Выключена" : "Включена")), /* @__PURE__ */ u.createElement(
    "button",
    {
      type: "button",
      className: te.moreButton,
...
`).filter(Boolean)
  ...
  v.useEffect(() => {
    !x || !l || !E || M || !le || le.page >= le.total_pages || k(
      "get_assistant_sub_direct_control_samples_short",
      le.page + 1,
      !0
    );
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement("div", { className: te.page }, !l && /* @__PURE__ */ u.createElement(Gt, null), M && /* @__PURE__ */ u.createElement("div", { className: te.state }, "Загрузка..."), /* @__PURE__ */ u.createElement("div", { className: te.header }, /* @__PURE__ */ u.createElement("div", { className: te.headerTop }, /* @__PURE__ */ u.createElement("div", { className: te.innerTabs }, D.map((X) => /* @__PURE__ */ u.createElement(
    ...
    "Добавить сценарий"
  ))), /* @__PURE__ */ u.createElement("div", { className: te.commandList }, le == null ? void 0 : le.data.map((X) => /* @__PURE__ */ u.createElement(
    "div",
    {
      key: X.uuid,
    ...
    vr,
    {
      page: (le == null ? void 0 : le.page) ?? 1,
      totalPages: (le == null ? void 0 : le.total_pages) ?? 1,
      onChange: (X) => k(
        "get_assistant_sub_direct_control_samples_short",
        X
      )
...
}, Bg = "_form_nymr0_1", Wg = "_field_nymr0_15", Hg = "_textarea_nymr0_24", Ki = {
  form: Bg,
  field: Wg,
  textarea: Hg
}, Pd = () => ({
...
`)
  ...
  const l = kt(), [o, s] = v.useState(!1), [c, f] = v.useState(!1), [m, p] = v.useState(() => Md()), [h, _] = v.useState(null), { ref: C, inView: N } = hr({
    ...
    editStatusCommand: M,
    commands: k
  } = hl("get_assistant_settings_short"), [z, W] = v.useState(!1);
  v.useEffect(() => {
    !z || !l || !N || y || !k || k.page >= k.total_pages || x("get_assistant_settings_short", k.page + 1, !0);
  }, [
    N,
    l,
    y,
  ...
  const b = () => {
    ...
    f(!0);
    const oe = await D("get_assistant_command", Y.uuid);
    p(oe.data), s(!0);
  }, ee = async (Y, oe) => {
    console.log(Y, oe), await M("update_assistant_setting", Y, oe), x("get_assistant_settings_short");
  }, le = async (Y) => {
    await I("delete_assistant_setting", Y), x("get_assistant_settings_short");
  }, ve = async () => {
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement("div", { className: te.page }, l ? /* @__PURE__ */ u.createElement(u.Fragment, null) : /* @__PURE__ */ u.createElement(Gt, null), y && /* @__PURE__ */ u.createElement("div", { className: te.state }, "Загрузка..."), /* @__PURE__ */ u.createElement("div", { className: te.header }, /* @__PURE__ */ u.createElement("div", { className: te.headerTop }, /* @__PURE__ */ u.createElement("div", { className: te.heading }, /* @__PURE__ */ u.createElement("p", { className: te.description }, "Создавайте и редактируйте голосовые команды ассистента.")), l ? /* @__PURE__ */ u.createElement(yr, null, /* @__PURE__ */ u.createElement(
    ...
    vr,
    {
      page: (k == null ? void 0 : k.page) || 1,
      totalPages: (k == null ? void 0 : k.total_pages) || 1,
      onChange: (Y) => x("get_assistant_settings_short", Y)
    }
  ), /* @__PURE__ */ u.createElement(
    Vg,
    {
...
}, Qg = "_form_1bj0d_1", Yg = "_field_1bj0d_7", Kg = "_input_1bj0d_13", Gg = "_label_1bj0d_32", ft = {
  form: Qg,
  field: Yg,
  input: Kg,
  label: Gg
}, Xg = ({ data: l, onChange: o }) => {
  const s = (c, f) => {
    o({
      ...l,
      [c]: f
  ...
  return /* @__PURE__ */ u.createElement("div", { className: ft.form }, /* @__PURE__ */ u.createElement(Se, { label: "Base URL", value: l.base_url ?? "", placeholder: "http://192.168.31.83:9379", onChange: (c) => s("base_url", c.target.value) }), /* @__PURE__ */ u.createElement(Se, { label: "Token", value: l.token ?? "", placeholder: "Bearer ...", onChange: (c) => s("token", c.target.value) }));
  ...
  return /* @__PURE__ */ u.createElement("div", { className: ft.form }, /* @__PURE__ */ u.createElement(Se, { label: "Global music timer", value: l.global_music_timer ?? "", onChange: (c) => s("global_music_timer", c.target.value) }), /* @__PURE__ */ u.createElement(Se, { label: "Global music alarm", value: l.global_music_alarm ?? "", onChange: (c) => s("global_music_alarm", c.target.value) }));
...
const l_ = {
  ...
  yandex_tts: o_(l == null ? void 0 : l.yandex_tts),
  remout: i_(l == null ? void 0 : l.remout),
  timer_alarm: s_(l == null ? void 0 : l.timer_alarm),
  ...
  kt();
  const [l, o] = v.useState(Ld), [s, c] = v.useState(Ld), { settings: f, saveSettings: m } = r_();
  v.useEffect(() => {
    if (!f) return;
    const h = u_(f);
    o(h), c(h);
  ...
  return /* @__PURE__ */ u.createElement(u.Fragment, null, /* @__PURE__ */ u.createElement(Fn, null), /* @__PURE__ */ u.createElement(Gt, null), /* @__PURE__ */ u.createElement("div", { className: n_.page }, /* @__PURE__ */ u.createElement("h1", null, "Настройки"), /* @__PURE__ */ u.createElement(Ft, { title: "Общие", defaultOpen: !0 }, /* @__PURE__ */ u.createElement(
    e_,
    {
      data: {
...
function df() {
  const l = ml(), [o, s] = v.useState([]), [c, f] = v.useState([]), [m, p] = v.useState([]), [h, _] = v.useState(!0), C = v.useMemo(() => l.getDevices(), [l]), N = v.useCallback(async () => {
    const z = await l._getShort("get_timer_requests_short", 1, 100), W = await Promise.all(
      Xi(z).map(async (b) => {
        var ee;
        const B = await l._getDetail(b.uuid, "get_timer_request");
        return ((ee = zn(B)) == null ? void 0 : ee.data) ?? zn(B);
      })
    );
    s(W.filter((b) => !!b && b.action_type === "create_timer"));
  }, [l]), y = v.useCallback(async () => {
    const z = await l._getShort("get_alarm_requests_short", 1, 100), W = await Promise.all(
      Xi(z).map(async (b) => {
        var ee;
        const B = await l._getDetail(b.uuid, "get_alarm_request");
        return ((ee = zn(B)) == null ? void 0 : ee.data) ?? zn(B);
      })
    );
    f(W.filter((b) => !!b && b.action_type !== "delete_alarm"));
  }, [l]), x = v.useCallback(async () => {
    const z = await l._getShort("get_alarm_time_widgets_short", 1, 100), W = await Promise.all(
      Xi(z).map(async (b) => {
        var ee;
        const B = await l._getDetail(b.uuid, "get_alarm_time_widget");
        return ((ee = zn(B)) == null ? void 0 : ee.data) ?? zn(B);
      })
    );
    p(W.filter(Boolean));
  ...
  return v.useEffect(() => {
    ...
    alarmTimeWidgets: m,
    alarms: c,
    createAlarm: async (z, W, b = 0.3) => {
      await l._save({ name: `Будильник ${W}`, action_type: "create_alarm", device_id: z, status: "on", time: W, volume_start: b }, "save_alarm_request"), await y();
    },
    createTimer: async (z, W) => {
      const b = {
        count_timer: m_(W),
        date_end: f_(W)
      };
      await l._save({ name: `Таймер ${W} мин`, action_type: "create_timer", device_id: z, timer_time: b }, "save_timer_request"), await N();
    },
    deleteAlarm: async (z) => {
    ...
    timers: o,
    toTimerSeconds: cf,
    updateAlarm: async (z, W) => {
      await l._update(z.uuid, "update_alarm_request", { ...z, action_type: "edit_alarm", ...W }), await y();
    }
  };
}
const p_ = "_page_di7r7_1", h_ = "_header_di7r7_11", v_ = "_title_di7r7_18", y_ = "_description_di7r7_25", g_ = "_grid_di7r7_31", __ = "_card_di7r7_37", E_ = "_empty_di7r7_37", w_ = "_cardHeader_di7r7_44", k_ = "_cardTitle_di7r7_51", S_ = "_meta_di7r7_56", C_ = "_time_di7r7_62", N_ = "_form_di7r7_69", x_ = "_field_di7r7_75", T_ = "_label_di7r7_81", R_ = "_select_di7r7_87", P_ = "_input_di7r7_87", M_ = "_quickTabs_di7r7_97", L_ = "_quickTab_di7r7_97", I_ = "_activeQuickTab_di7r7_113", $_ = "_row_di7r7_118", Z = {
  page: p_,
  header: h_,
  title: v_,
  description: y_,
...
}, D_ = [5, 10, 15, 30, 60], z_ = (l) => {
  const o = Math.max(0, l), s = Math.floor(o / 3600), c = Math.floor(o % 3600 / 60), f = o % 60;
  return [s, c, f].map((m) => String(m).padStart(2, "0")).join(":");
}, O_ = () => {
  kt();
  const { createTimer: l, devices: o, loading: s, stopTimer: c, timers: f, toTimerSeconds: m } = df(), [p, h] = v.useState(!1), [_, C] = v.useState(""), [N, y] = v.useState(5), [x, I] = v.useState({});
  v.useEffect(() => {
    I((E) => Object.fromEntries(f.map((M) => [M.uuid, E[M.uuid] ?? m(M.timer_time)])));
  }, [f, m]), v.useEffect(() => {
    const E = window.setInterval(() => {
      I((M) => Object.fromEntries(Object.entries(M).map(([k, z]) => [k, Math.max(0, z - 1)])));
    }, 1e3);
  ...
  return /* @__PURE__ */ u.createElement("div", { className: Z.page }, /* @__PURE__ */ u.createElement(Gt, null), /* @__PURE__ */ u.createElement("div", { className: Z.header }, /* @__PURE__ */ u.createElement("div", null, /* @__PURE__ */ u.createElement("h1", { className: Z.title }, "Таймер"), /* @__PURE__ */ u.createElement("p", { className: Z.description }, "Создавайте таймеры для выбранных устройств и отслеживайте обратный отсчет.")), /* @__PURE__ */ u.createElement(se, { onClick: () => h(!0) }, "Создать")), s && /* @__PURE__ */ u.createElement("div", null, "Загрузка..."), /* @__PURE__ */ u.createElement("div", { className: Z.grid }, f.length ? f.map((E) => /* @__PURE__ */ u.createElement("div", { className: Z.card, key: E.uuid }, /* @__PURE__ */ u.createElement("div", { className: Z.cardHeader }, /* @__PURE__ */ u.createElement("div", null, /* @__PURE__ */ u.createElement("h2", { className: Z.cardTitle }, E.name || "Таймер"), /* @__PURE__ */ u.createElement("div", { className: Z.meta }, "Устройство: ", D.get(E.device_id) || E.device_id)), /* @__PURE__ */ u.createElement(se, { variant: "ghost", onClick: () => c(E) }, "Стоп")), /* @__PURE__ */ u.createElement("div", { className: Z.time }, z_(x[E.uuid] ?? m(E.timer_time))))) : /* @__PURE__ */ u.createElement("div", { className: Z.empty }, "Нет запущенных таймеров.")), /* @__PURE__ */ u.createElement(Kt, { open: p, onClose: () => h(!1), title: "Создать таймер", footer: /* @__PURE__ */ u.createElement(se, { onClick: $, disabled: !_ }, "Создать") }, /* @__PURE__ */ u.createElement("div", { className: Z.form }, /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Устройство"), /* @__PURE__ */ u.createElement("select", { className: Z.select, value: _, onChange: (E) => C(E.target.value) }, /* @__PURE__ */ u.createElement("option", { value: "" }, "Выберите устройство"), o.map((E) => /* @__PURE__ */ u.createElement("option", { key: E.id, value: E.id }, E.name)))), /* @__PURE__ */ u.createElement("div", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Быстрый старт"), /* @__PURE__ */ u.createElement("div", { className: Z.quickTabs }, D_.map((E) => /* @__PURE__ */ u.createElement("button", { key: E, type: "button", className: `${Z.quickTab} ${N === E ? Z.activeQuickTab : ""}`, onClick: () => y(E) }, E, " мин")))), /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Свое значение, минут"), /* @__PURE__ */ u.createElement("input", { className: Z.input, type: "number", min: "1", value: N, onChange: (E) => y(Number(E.target.value) || 1) })))), /* @__PURE__ */ u.createElement(Xt, null));
}, A_ = () => {
  kt();
  const { alarmTimeWidgets: l, alarms: o, createAlarm: s, deleteAlarm: c, devices: f, loading: m, updateAlarm: p } = df(), [h, _] = v.useState(!1), [C, N] = v.useState(""), [y, x] = v.useState("08:00"), [I, D] = v.useState(0.3), $ = v.useMemo(() => {
    const k = l.flatMap((z) => z.time || []);
    return Array.from(new Set(k)).filter(Boolean);
  }, [l]), E = v.useMemo(() => new Map(f.map((k) => [k.id, k.name])), [f]), M = async () => {
    !C || !y || (await s(C, y, I), _(!1));
  };
  return /* @__PURE__ */ u.createElement("div", { className: Z.page }, /* @__PURE__ */ u.createElement(Gt, null), /* @__PURE__ */ u.createElement("div", { className: Z.header }, /* @__PURE__ */ u.createElement("div", null, /* @__PURE__ */ u.createElement("h1", { className: Z.title }, "Будильник"), /* @__PURE__ */ u.createElement("p", { className: Z.description }, "Управляйте будильниками, временем срабатывания, устройством и состоянием.")), /* @__PURE__ */ u.createElement(se, { onClick: () => _(!0) }, "Создать")), m && /* @__PURE__ */ u.createElement("div", null, "Загрузка..."), /* @__PURE__ */ u.createElement("div", { className: Z.grid }, o.length ? o.map((k) => /* @__PURE__ */ u.createElement("div", { className: Z.card, key: k.uuid }, /* @__PURE__ */ u.createElement("div", { className: Z.cardHeader }, /* @__PURE__ */ u.createElement("div", null, /* @__PURE__ */ u.createElement("h2", { className: Z.cardTitle }, k.name || "Будильник"), /* @__PURE__ */ u.createElement("div", { className: Z.meta }, "Устройство: ", E.get(k.device_id) || k.device_id)), /* @__PURE__ */ u.createElement(se, { variant: "ghost", onClick: () => c(k) }, "Удалить")), /* @__PURE__ */ u.createElement("label", { className: `${Z.row} ${Z.meta}` }, /* @__PURE__ */ u.createElement("input", { className: Z.switch, type: "checkbox", checked: k.status !== "off", onChange: (z) => p(k, { status: z.target.checked ? "on" : "off" }) }), k.status !== "off" ? "Включен" : "Выключен"), /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Время"), /* @__PURE__ */ u.createElement("input", { className: Z.input, type: "time", value: k.time, onChange: (z) => p(k, { time: z.target.value }) })), /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Стартовая громкость"), /* @__PURE__ */ u.createElement(
    "input",
    {
      className: Z.input,
      type: "number",
      ...
      max: "1",
      step: "0.05",
      value: k.volume_start ?? 0.3,
      onChange: (z) => p(k, { volume_start: Number(z.target.value) })
    }
  )))) : /* @__PURE__ */ u.createElement("div", { className: Z.empty }, "Нет запущенных будильников.")), /* @__PURE__ */ u.createElement(Kt, { open: h, onClose: () => _(!1), title: "Создать будильник", footer: /* @__PURE__ */ u.createElement(se, { onClick: M, disabled: !C || !y }, "Создать") }, /* @__PURE__ */ u.createElement("div", { className: Z.form }, /* @__PURE__ */ u.createElement("div", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Быстрый старт"), /* @__PURE__ */ u.createElement("div", { className: Z.quickTabs }, $.length ? $.map((k) => /* @__PURE__ */ u.createElement("button", { key: k, type: "button", className: `${Z.quickTab} ${y === k ? Z.activeQuickTab : ""}`, onClick: () => x(k) }, k)) : /* @__PURE__ */ u.createElement("span", { className: Z.meta }, "Нет быстрых значений из alarm_time_widget."))), /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Устройство"), /* @__PURE__ */ u.createElement("select", { className: Z.select, value: C, onChange: (k) => N(k.target.value) }, /* @__PURE__ */ u.createElement("option", { value: "" }, "Выберите устройство"), f.map((k) => /* @__PURE__ */ u.createElement("option", { key: k.id, value: k.id }, k.name)))), /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Время"), /* @__PURE__ */ u.createElement("input", { className: Z.input, type: "time", value: y, onChange: (k) => x(k.target.value) })), /* @__PURE__ */ u.createElement("label", { className: Z.field }, /* @__PURE__ */ u.createElement("span", { className: Z.label }, "Стартовая громкость"), /* @__PURE__ */ u.createElement(
    "input",
    {
      className: Z.input,
      type: "number",
...
}, F_ = () => /* @__PURE__ */ u.createElement(mh, null, /* @__PURE__ */ u.createElement(
  at,
  {
    path: "/",
  ...
  {
    path: "/scripts",
    element: /* @__PURE__ */ u.createElement(rg, null)
  }
), /* @__PURE__ */ u.createElement(
  at,
  {
  ...
  at,
  {
    ...
    element: /* @__PURE__ */ u.createElement(Fg, null)
  }
), /* @__PURE__ */ u.createElement(
  at,
  {
  ...
  {
    path: "/timer",
    element: /* @__PURE__ */ u.createElement(O_, null)
  }
), /* @__PURE__ */ u.createElement(
  at,
  {
  ...
  {
    path: "/settings",
    element: /* @__PURE__ */ u.createElement(d_, null)
  }
), /* @__PURE__ */ u.createElement(
  at,
  {
...
)), j_ = () => /* @__PURE__ */ u.createElement(F_, null);
class U_ {
  constructor(o) {
    this.hass = o;
  }
...
const B_ = 1, ja = 2, Ji = 3, W_ = 4, H_ = 5;
function V_(l) {
  return {
    type: "auth",
    access_token: l
...
function J_(l) {
  ...
  function f(m, p, h) {
    ...
    const N = () => {
      ...
      try {
        o.expired && await (s || o.refreshAccessToken()), _.send(JSON.stringify(V_(o.accessToken)));
      } catch (D) {
        C = D === ja, _.close();
      }
    }, x = async (I) => {
      ...
      switch (D.type) {
        case G_:
          ...
          break;
        case X_:
          _.removeEventListener("open", y), _.removeEventListener("message", x), _.removeEventListener("close", N), _.removeEventListener("error", N), _.haVersion = D.ha_version, K_(_.haVersion, 2022, 9) && _.send(JSON.stringify(b_())), p(_);
          break;
      }
    };
...
class Z_ {
  constructor(o, s) {
    this._handleMessage = (c) => {
      ...
      if (this.commandId = 1, this.oldSubscriptions = this.commands, this.commands = /* @__PURE__ */ new Map(), this.socket = void 0, c.forEach((p) => {
        "subscribe" in p || p.reject(Y_(Ji, "Connection lost"));
      }), this.closeRequested)
        return;
  ...
  ping() {
    return this.sendMessagePromise(Q_());
  }
  sendMessage(o, s) {
    if (!this.connected)
      throw Ji;
...
const e0 = (l) => l * 1e3 + Date.now();
async function t0(l, o, s) {
  ...
  return p.hassUrl = l, p.clientId = o, p.expires = e0(p.expires_in), p;
}
class n0 {
  constructor(o, s) {
  ...
  async refreshAccessToken() {
    ...
    const o = await t0(this.data.hassUrl, this.data.clientId, {
...
async function l0(l) {
  const o = Object.assign({ setupRetry: 0, createSocket: J_ }, l), s = await o.createSocket(o);
  return new Z_(s, o);
}
function a0(l) {
  var o;
...
function i0({
  ...
  return v.useEffect(() => {
    async function m() {
      const p = o ? a0(o) : await o0();
      s.current ? s.current.setHass(p) : s.current = new U_(p), f(!0);
    }
...
function s0({ hass: l }) {
  return /* @__PURE__ */ u.createElement(Ah, null, /* @__PURE__ */ u.createElement(i0, { hass: l }, /* @__PURE__ */ u.createElement(j_, null)));
}
...
class u0 extends HTMLElement {
  ...
  render() {
    ...
    this.root || (this.root = hp.createRoot(o)), this.root.render(
      /* @__PURE__ */ u.createElement(u.StrictMode, null, /* @__PURE__ */ u.createElement(s0, { hass: this.hassValue }))
    );
  }
}
customElements.get($d) || customElements.define($d, u0);
