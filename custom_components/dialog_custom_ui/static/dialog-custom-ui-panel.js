                ...
                <section class="response-item-card ${a?"open":""}">
                  ...
                  ${a?`
                    <div class="response-item-grid">
                      ...
                      ${String(i.mappingType??"").trim()?`
                        <label>
                          <span>mappingType</span>
                          <input value="${h(i.mappingType)}" disabled />
                        </label>
                      `:""}
                      <div class="response-item-actions">
                        <button
